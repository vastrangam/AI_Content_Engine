# Medhava — Build Roadmap

Everything, in one file: the ten stages from idea to launch, then all 31 modules, all 165 apps and all 302 rules in full — each rule with what the system does, what it refuses to do instead, and the test that proves it where one exists.
...
| SPECIFIED | Designed and ruled, not built | 146 |

One app is counted twice above — a browser screen came first and the platform implementation second, and both are true. 165 apps in total.

| | Count | |
|---|---:|---|
| Modules | 31 | one of them is the spine, not a screen you open |
| Apps | 165 | 3 running, 16 browser apps, 2 engines |
| Rules | 302 | **89 proven by a test that runs**, 213 specified |
...
| Specified screens | 55 | column by column |

**The gap between 89 and 302 is the build queue.** It is not a rounding error and it is not hidden: every rule below says which side of it it is on.
...
# Part two — the 31 modules, in full
...
| 16 | HR & Payroll | 6 | 22 | 8 |
| 17 | Marketing | 9 | 10 | 0 |
| 18 | AI Content Engine | 8 | 11 | 2 |
| 19 | SEO, AEO & AIO | 3 | 6 | 0 |
| 20 | Projects & Collaboration | 7 | 9 | 1 |
| 21 | Dashboard & BI | 9 | 9 | 6 |
| 22 | AI Assistant, Agents & Automation | 7 | 15 | 2 |
| 23 | Developer Platform | 9 | 1 | 0 |
| 24 | Agile & Sprints | 4 | 1 | 0 |
| 25 | Meetings | 4 | 1 | 0 |
| 26 | Calendar | 4 | 1 | 0 |
| 27 | Mail | 5 | 1 | 0 |
| 28 | Documents | 5 | 1 | 0 |
| 29 | Learning | 3 | 1 | 0 |
| 30 | Integration Platform | 3 | 1 | 0 |
| 31 | Identity & IT | 4 | 1 | 0 |
...
Not a module you open — the layer underneath all 31. Who can see what, how the system is configured, and a record of everything that ever happened. Foundation first: nothing downstream can be built before identity, roles and the audit trail exist.
...
Ask from your phone, anywhere: a ledger, a bill, today’s packing slips. It comes back as a PDF — or prints on the office printer, with nothing plugged into your phone.
...
**Appearance & Localisation** — SPECIFIED — designed, not built
...
First idea to something you can actually make: specification, sample rounds, costed trials and sign-off, with every version kept. A product, a machined part, a formulation or a service package all move through stages you set yourself.
...
### The 3 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Part development · revision 4 · awaiting sign-off** · shown for a Precision components maker

- **Figures across the top** — Open developments 14 · At customer approval 5 · Rounds this part 4 · Cost vs target +6%
- **Columns** — Part · Revision · What changed · Stage
- **Rows** — 4 worked examples, the first reading: BR-2214 bracket · r4 · Wall 2.5 → 3.0 mm after fatigue test · At customer
- **Controls** — Revisions kept in full · Parts released without sign-off

**Recipe development · set yoghurt · trial 3** · shown for a Dairy co-operative

- **Figures across the top** — Recipes in trial 7 · Awaiting panel 2 · Shelf-life days 21 · Yield vs target 98.2%
- **Columns** — Recipe · Trial · What changed · Stage
- **Rows** — 4 worked examples, the first reading: Set yoghurt 3.5% · t3 · Culture blend B, 6 h at 42 °C · Tasting panel
- **Controls** — Trials with a recorded reason · Recipes released untasted

**Concept development · brand refresh · round 2** · shown for a Creative agency

- **Figures across the top** — Live concepts 9 · With client 3 · Rounds included 3 · Rounds used 2
- **Columns** — Concept · Round · What changed · Stage
- **Rows** — 4 worked examples, the first reading: Identity · route A · r2 · Wordmark weight, palette narrowed to 3 · With client
- **Controls** — Rounds inside the retainer · Concepts billed without a signed round
...
**Product record · one product, every channel’s name for it** · shown for a Drone & precision manufacturer

- **Figures across the top** — SKUs live 2,418 · Mapped on all channels 2,301 · Missing size or weight 37 · Below reorder 44
- **Columns** — Your code · Channel · Their code · Packed size · weight · Sells at
- **Rows** — 4 worked examples, the first reading: DRN-A22 · Marketplace A · B0DXXXXABC · 30×25×3 cm · 0.45 kg · ₹1,947
- **Controls** — Codes mapped on every live channel · Size and weight on file

**Stock · four kitchens · one number per item** · shown for a Restaurant group

- **Figures across the top** — Items tracked 412 · Below par 23 · Expiring in 3 days 9 · Value on hand ₹6.8 L
- **Columns** — Item · Kitchen · On hand · Par · State
- **Rows** — 4 worked examples, the first reading: Paneer · Andheri · 18 kg · 25 kg · Below par
- **Controls** — Counted against the recipe that consumed it · Kitchens with a separate stock figure

**Van stock · six vans and the main store** · shown for a HVAC service firm

- **Figures across the top** — Parts tracked 268 · Vans below kit 2 · Used, unbilled ₹41,200 · Store value ₹9.2 L
- **Columns** — Part · Location · On hand · Kit level · State
- **Rows** — 4 worked examples, the first reading: Capacitor 45+5 µF · Van 3 · 1 · 4 · Restock
- **Controls** — Parts consumed on a job, billed to it · Vans holding untracked stock
...
Lead to won, then the full lifetime: orders, returns, value and what to offer next.

**Documents & eSign** — **BROWSER APP** — opens and self-tests, no shared database behind it

Every agreement, receipt, certificate and scan filed against the record it belongs to — an order, a party, a case, an employee — so it is found by that record instead of by remembering a folder. Send one out for signature and the signed copy files itself back.

**Helpdesk & Live Chat** — **BROWSER APP** — opens and self-tests, no shared database behind it

Questions arriving by chat, email or phone become tickets tied to the order or the account they are about, with the whole history already on the screen.
...
- **Rows** — 4 worked examples, the first reading: SO-4471 · Order · 40 airframe kits · 12 Jul · Delivered
- **Controls** — First reply under 2 h · Resolved same day

**Learner 360 · one record, enquiry to alumnus** · shown for a Training institute

- **Figures across the top** — Lifetime fees ₹1,84,000 · Open queries 1 · Outstanding ₹22,000 · Attendance 86%
- **Columns** — Record · What it is · When · State
- **Rows** — 4 worked examples, the first reading: ENQ-3312 · Enquiry · data analytics · 04 Feb · Converted
- **Controls** — Learners with one unified record · Duplicate records after re-enrolment
...
Wholesale orders with credit limits, tier pricing and outstanding ageing.

**Export** — **BROWSER APP** — opens and self-tests, no shared database behind it

Commercial invoice, packing list, LUT bond and IGST-refund tracking.

**POS** — **BROWSER APP** — opens and self-tests, no shared database behind it

Counter billing that draws on the same stock as your website.
...
Book the shipment on the order itself, compare couriers, print the label and follow the AWB to the door.
...
**Appointment Booking** — SPECIFIED — designed, not built

A slot a customer books for themselves — a fitting, a consultation, a service visit — against the real availability of whoever or whatever is needed for it. It writes to the same Calendar the rest of the business works from, so a booking taken on a website at midnight cannot collide with something already in the diary.

### The 3 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Order book · every channel, one list** · shown for a Drone & precision manufacturer

- **Figures across the top** — Orders today 312 · To dispatch 118 · Credit held 7 · Avg order ₹8,940
- **Columns** — Order · Customer · Channel · Value · State
- **Rows** — 4 worked examples, the first reading: SO-4489 · Nagarjuna Traders · B2B · 45 days · ₹2,84,000 · Credit hold
- **Controls** — Dispatched within cut-off · COD collected

**Appointment book · four chairs · today** · shown for a Multi-doctor clinic

- **Figures across the top** — Booked today 78 · Waiting 6 · No-shows 4 · Avg wait 9 min
- **Columns** — Time · Patient · Doctor · Procedure · State
- **Rows** — 4 worked examples, the first reading: 09:30 · P-4471 · Dr Rao · Root canal · sitting 2 · In chair
- **Controls** — Seen within 15 minutes of the slot · Slots double-booked

**Consignment book · every mode, one list** · shown for a Freight forwarder

- **Figures across the top** — Live consignments 142 · Awaiting docs 11 · Held at customs 3 · Avg transit 6.2 d
- **Columns** — Job · Shipper · Mode · Value · State
- **Rows** — 4 worked examples, the first reading: JOB-8841 · Northgate Components · Sea · FCL · $84,000 · At origin port
- **Controls** — Jobs with complete documents before departure · Consignments without a named owner
...
**Requirement run · week 34 · what to order** · shown for a Precision components maker

- **Figures across the top** — Shortfalls 23 · Already on order 9 · Order this week ₹18.4 L · Budget left ₹6.2 L
- **Columns** — Material · Needed · On order · Order now
- **Rows** — 4 worked examples, the first reading: EN8 bar 40 mm · 1,240 kg · 400 kg · 840 kg
- **Controls** — Shortfalls tracing to a real demand · Ordered twice

**Purchase plan · four kitchens · next 3 days** · shown for a Restaurant group

- **Figures across the top** — Lines to buy 41 · Short today 6 · Spend planned ₹2.14 L · Waste last week 3.1%
- **Columns** — Item · Covers forecast · Stock · Order
- **Rows** — 4 worked examples, the first reading: Chicken, boneless · 480 covers · 32 kg · 58 kg
- **Controls** — Ordered against a forecast, not a guess · Lines ordered below par
...
RFQ to purchase order to goods receipt, with a strict three-way match before any bill is paid.

> Proven by `medhava/test/purchase.test.js`.

**Vendor Management** — **BROWSER APP** — opens and self-tests, no shared database behind it

Vendor 360, payables, ageing, a real risk score, and sourcing that follows performance.
...
**Three-way match · nothing over-billed is paid** · shown for a Precision components maker

- **Figures across the top** — Open POs 62 · Bills held 5 · Payables ₹41.2 L · Avg accept rate 94%
- **Columns** — Bill · Supplier · Ordered · Accepted · Billed for
- **Rows** — 4 worked examples, the first reading: B-8841 · Northgate Components · 100 · 96 · 96 ✓
- **Controls** — Bills matched without a query · Spend with top supplier

**Site procurement · six live sites** · shown for a Interior contractor

- **Figures across the top** — Open orders 38 · Awaiting approval 4 · Committed ₹62.4 L · Over budget 1
- **Columns** — Order · Site · Material · Value · State
- **Rows** — 4 worked examples, the first reading: PO-2214 · Hotel lobby, Pune · Veneer ply 18 mm · ₹4,86,000 · Delivered
- **Controls** — Orders inside the site budget · Material ordered without a requirement
...
Your own stages from first operation to finished goods, with work-in-progress visible at each one.

**Piece-rate & Contractors** — SPECIFIED — designed, not built

Output-based pay for anyone paid by the piece rather than the hour — pooled completion, per-unit rates, rework and advances resolved into a single payout.

**BOM & Consumption** — SPECIFIED — designed, not built

What each product consumes, costed at today’s material rates.

**Maintenance** — SPECIFIED — designed, not built

Machines, tools and assets: what is due for service, when it was last done, what it cost, and what stopped while it was down. Planned and breakdown work against the same asset record.

### The 2 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Work in progress · your own stages** · shown for a Precision components maker

- **Figures across the top** — Open work orders 48 · Units in WIP 1,260 · Rework 3.1% · Cost per unit ₹18,420
- **Columns** — Stage · Units in · Units out · Rejected · Ageing
- **Rows** — 4 worked examples, the first reading: Machining · 420 · 406 · 14 · 1.2 d
- **Controls** — Accepted at first test · Orders finished on plan

**Batch production · today’s run** · shown for a Dairy co-operative

- **Figures across the top** — Batches today 24 · Yield 98.2% · Held for test 1 · Cost per litre ₹41.20
- **Columns** — Batch · Product · In · Out · Yield
- **Rows** — 4 worked examples, the first reading: DY-2209 · Set yoghurt 2 L · 4,180 L · 4,110 L · 98.3%
- **Controls** — Batches traceable to their intake farms · Yield losses with no recorded cause
...
Accept, reject or rework — on goods received and on goods made — with reasons that feed the supplier scorecard and the performance flags alike.
...
**Inspection · lot 8841 · first article** · shown for a Precision components maker

- **Figures across the top** — Lots checked today 18 · Failed 2 · Accept rate 96.4% · Certificates expiring 1
- **Columns** — Lot · Characteristic · Result · State
- **Rows** — 4 worked examples, the first reading: 8841 · Bore Ø12.00 +0.02 · 12.014 mm · Pass
- **Controls** — Failures blocking the next stage · Batches released with an open failure

**Traceability · batch DY-2209 · from milk to pack** · shown for a Dairy co-operative

- **Figures across the top** — Batches today 24 · On hold 1 · Recall reach < 4 min · Chain breaks 0
- **Columns** — Step · Record · When · State
- **Rows** — 4 worked examples, the first reading: Intake · 14 farms · 4,180 L · 3.9% fat · 05:40 · Logged
- **Controls** — Packs traceable to the farms that supplied them · Released before the test came back

**Compliance register · licences and calibration** · shown for a Multi-doctor clinic

- **Figures across the top** — Items tracked 62 · Due in 30 days 4 · Expired 0 · Evidence on file 100%
- **Columns** — Requirement · Reference · Expires · State
- **Rows** — 4 worked examples, the first reading: Clinical establishment licence · CE-2211 · 14 Mar 2027 · Valid
- **Controls** — Requirements with a document behind them · Ticked with nothing attached
...
Pick lists that tell staff exactly which bin to walk to, in walking order.
...
Every parcel recorded as it is packed and indexed by its order number, so a wrong-item claim is answered with the clip. The footage attaches itself to the claim that needs it.

### The 2 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Pick wave 22 · Zone A → C** · shown for a Drone & precision manufacturer

- **Figures across the top** — Lines to pick 486 · Pickers on floor 6 · Short-picked 4 · Packed & filmed 241
- **Columns** — Bin · Item · Qty · Picker · State
- **Rows** — 4 worked examples, the first reading: A-04-2 · Carbon arm 220 mm · 24 · Ravi · Picked
- **Controls** — Picked first time right · Parcels with footage

**Bonded warehouse · cargo in and out** · shown for a Freight forwarder

- **Figures across the top** — Consignments held 86 · Cleared today 22 · Over 30 days 7 · Space used 74%
- **Columns** — Location · Consignment · Pieces · Held since · State
- **Rows** — 4 worked examples, the first reading: BAY-A1 · JOB-8811 · machinery · 4 · 12 d · Cleared
- **Controls** — Cargo located on first search · Pieces released without a customs record
...
What the courier collected at the door against what reached your bank, parcel by parcel, with every shortfall named and aged.

**Handover & Manifest** — SPECIFIED — designed, not built

What is expected out today against what the courier actually took, counted per courier and per service. The manifest to hand over, the one-time code to confirm it, and a signed record of the parcels that were left behind — so a parcel lost between your table and their van has an owner.
...
**Handover · what went out against what they took** · shown for a Drone & precision manufacturer
...
**Today’s route · six engineers** · shown for a HVAC service firm

- **Figures across the top** — Jobs scheduled 41 · Completed 28 · Running late 3 · First-time fix 86%
- **Columns** — Engineer · Job · Window · Travel · State
- **Rows** — 4 worked examples, the first reading: A. Deshpande · JOB-2214 · AMC service · 09–11 · 12 km · Done
- **Controls** — Jobs closed on the first visit · Parts fitted without being booked out
...
GST tax invoices and receipts, totals computed from the lines to the paise. Where a channel raises its own invoice, both numbers live on the order — theirs and yours — so the panel’s paperwork and your books point at the same sale and neither has to be re-keyed to find the other.
...
P&L, balance sheet, and profit by channel, product and SKU.

### The 2 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Trial balance · it always ties** · shown for a Drone & precision manufacturer
...
**Practice accounts · office and client money kept apart** · shown for a Law practice

- **Figures across the top** — Billed YTD ₹4.62 Cr · WIP unbilled ₹68.2 L · Client account ₹1.14 Cr · Realisation 82%
- **Columns** — Head · Office · Client · This month
- **Rows** — 4 worked examples, the first reading: Fees billed · ₹42,08,400 · — · +9%
- **Controls** — Client money never mixed with office money · Time recorded on the day it happened
...
**Cash position · four sites · next 14 days** · shown for a Restaurant group

- **Figures across the top** — Cash + bank ₹18.6 L · Due out ₹22.4 L · Expected in ₹26.1 L · Tightest day Day 9
- **Columns** — When · Out · In · Running
- **Rows** — 4 worked examples, the first reading: This week · ₹9.8 L · ₹11.2 L · ₹20.0 L
- **Controls** — Forecast lines with a named assumption · Projections posted to the ledger

**Retention and stage payments · 6 live sites** · shown for a Interior contractor

- **Figures across the top** — Certified, unpaid ₹41.2 L · Retention held ₹12.8 L · Overdue > 60 d ₹7.4 L · Next release Day 6
- **Columns** — Site · Stage certified · Retention · State
- **Rows** — 4 worked examples, the first reading: Hotel lobby, Pune · Stage 3 of 5 · ₹4.2 L · Invoiced
- **Controls** — Retention tracked to its release date · Certified work invisible until invoiced
...
- **Columns** — Channel · Cycle · Should pay · Paid · Gap
- **Rows** — 4 worked examples, the first reading: Amazon · 12–18 Jul · ₹18,40,000 · ₹18,40,000 · ₹0
...
Turn shortfalls, weight disputes and lost parcels into filed claims with evidence — and answer them before the clock runs out. A claim that is awaiting your response is worth money; one closed for no response is worth nothing, so the days remaining sit on the screen next to the amount.

**Returns / RMA** — SPECIFIED — designed, not built

Customer, courier and wrong returns — and the dead stock they actually cost you.
...
**Order queue · 9 channels · dispatch cut-off running**

- **Figures across the top** — To accept 62 · To pack 214 · Cut-off in 2 h 9 · Handed over today 188
- **Columns** — Channel · To accept · To pack · RTD · Cut-off
- **Rows** — 5 worked examples, the first reading: Amazon · 18 · 62 · 48 · 1 PM
- **Controls** — Dispatched inside the cut-off · Labels printed straight from here

**Order queue · storefront and marketplaces** · shown for a Homeware brand · D2C

- **Figures across the top** — To accept 48 · To pack 186 · Cut-off in 2 h 14 · Return rate 6.4%
- **Columns** — Channel · To accept · To pack · RTD · Cut-off
- **Rows** — 4 worked examples, the first reading: Own storefront · — · 62 · 62 · none
- **Controls** — Dispatched inside the cut-off · Stock oversold across channels
...
### The 6 apps in this module

**Staff & Contractors** — SPECIFIED — designed, not built

Attendance, effective-dated salary and output-based earnings in a single register, whoever is on it.

**Time-off & Advances** — SPECIFIED — designed, not built

Leave, festival advances, and exactly how they change this month’s payout.
...
**Rota and pay · four sites · this week** · shown for a Restaurant group

- **Figures across the top** — On roll 124 · Shifts unfilled 5 · Overtime hours 86 · Wage % of sales 24.1%
- **Columns** — Person · Site · Shifts · Hours · State
- **Rows** — 4 worked examples, the first reading: Kitchen · commis · Andheri · 6 · 48 h · Approved
- **Controls** — Shifts filled before the day starts · Hours paid without a rota line

**Roster and payout · clinical and support** · shown for a Multi-doctor clinic

- **Figures across the top** — On roll 34 · On duty now 19 · Locum shifts 4 · Payout due ₹18.2 L
- **Columns** — Person · Basis · Sessions / hours · Earned · State
- **Rows** — 4 worked examples, the first reading: Dr Rao · Per session · 22 sessions · ₹4,40,000 · Approved
- **Controls** — Sessions matched to the appointments they served · Locum paid without a signed session
...
Rules per channel and SKU — floor, ceiling, match-lowest, festival overrides — and what each change actually did. A price that went up and took the orders down with it shows as exactly that, next to the rule that raised it, so the rule can be reversed on evidence rather than on a feeling.
...
**Social Engagement & Inbox** — SPECIFIED — designed, not built

The replies, comments and messages that arrive on the accounts the business posts from, in one queue rather than four apps on somebody’s phone. Distinct from the Social Calendar, which decides what goes out: this is what comes back, and it is where a complaint first appears in public. A message here can become a Helpdesk ticket with the thread already attached, so a public question and a private one end up in the same place.
...
- **Rows** — 4 worked examples, the first reading: Winter launch · Email · ₹42,000 · ₹6,10,000 · 14.5×
- **Controls** — Priced above floor everywhere · Posts published on schedule

**Admissions funnel · measured on enrolments** · shown for a Training institute

- **Figures across the top** — Enquiries 1,284 · Enrolled 186 · Cost per enrolment ₹2,140 · Fill rate 78%
- **Columns** — Source · Enquiries · Enrolled · Spend · Cost each
- **Rows** — 4 worked examples, the first reading: Search · 486 · 82 · ₹1,84,000 · ₹2,244
- **Controls** — Enrolments traced to a source · Spend judged on clicks
...
Fourteen stages in your own voice, from buyer research and competitor reading through hooks, channel-ready listings, ads, social posts, video scripts, song lyrics, the publishing calendar and alt text — each written from your own catalogue, so the words match the thing.

**Image Studio** — SPECIFIED — designed, not built

Layers, free transform, background removal, channel presets and SEO alt text — a phone photo becomes a channel-compliant product image.
...
A full design surface — templates, layers, undo and redo, any colour, exact sizing, background images and stock elements — exporting PNG, JPG or PDF at whatever size the channel or the printer asks for.
...
One push sends the finished listing, picture and copy everywhere it has to appear — your storefront, each marketplace, each social account — and reports back what actually went live and what was rejected, with the reason.

### The 2 specified screens

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Content pipeline · written from your own catalogue**

- **Figures across the top** — Listings this week 184 · Images produced 612 · Reels cut 38 · Rejected by channel 2
- **Columns** — Item · What was made · Channel · State
- **Rows** — 4 worked examples, the first reading: DRN-A22 · Listing · title, bullets, A+ · Amazon · Live
- **Controls** — Written from real catalogue data · Published in one push

**Content pipeline · client work, tracked to the retainer** · shown for a Creative agency

- **Figures across the top** — Pieces this week 142 · Awaiting approval 18 · Rejected by client 3 · Hours booked 218
- **Columns** — Client · Deliverable · Channel · State
- **Rows** — 4 worked examples, the first reading: Homeware brand · 12 product listings · Marketplace · Live
- **Controls** — Pieces booked to a retainer line · Work delivered outside a signed scope
...
**Local search · what patients actually search** · shown for a Multi-doctor clinic

- **Figures across the top** — Tracked queries 128 · In the map pack 41 · Cited by an assistant 12 · Pages with schema 96%
- **Columns** — Query · Position · Assistant cites us · Page
- **Rows** — 4 worked examples, the first reading: dentist near Koregaon Park · 2 · Yes · /dental
- **Controls** — Pages whose markup matches what is on them · Claims marked up that the page does not make

**Answer-engine visibility · category questions** · shown for a Homeware brand · D2C

- **Figures across the top** — Questions tracked 86 · Cited 29 · Cited last month 17 · Feed errors 0
- **Columns** — Question an assistant is asked · Cited · Source page · Trend
- **Rows** — 4 worked examples, the first reading: best cookware for induction · Yes · /guides/induction · +6
- **Controls** — Answers traceable to a page we publish · Positions quoted from a single sample
...
A project, a case file, an engagement or a job — whatever your work is called. Stages you define, owners, deadlines, documents, billable time and real cost, all on one record the ledger can see.

**Timesheets & Planning** — SPECIFIED — designed, not built

Who is on what this week, and the hours that actually went in — against a project, a case, a job or a machine. Billable and non-billable separated, so a rate card turns straight into an invoice and a real cost.

**Approvals** — SPECIFIED — designed, not built

One queue for everything waiting on a yes — a purchase order, a discount, a leave day, a credit note, a payment. The rule that sent it there is on the screen next to it, and the decision goes to the audit record.
...
Conversation attached to the record it is about: this order, this bill, this case. A year later the reason for a decision is still sitting next to the decision.
...
**Live matters · a practice, not a production line** · shown for a Law practice

- **Figures across the top** — Open matters 34 · Billable this month 1,248 h · Unbilled WIP ₹18.4 L · Due this week 6
- **Columns** — Matter · Client · Stage · Hours · Due
- **Rows** — 4 worked examples, the first reading: GST-2026-11 · Skyward Robotics · Assessment reply · 62 · 4 Aug
- **Controls** — Hours captured same day · Matters billed within 7 days

**Live sites · stages, cost and certification** · shown for a Interior contractor

- **Figures across the top** — Live sites 6 · Behind plan 2 · Certified, unpaid ₹41.2 L · Margin to date 19.4%
- **Columns** — Site · Stage · Value · Cost to date · State
- **Rows** — 4 worked examples, the first reading: Hotel lobby, Pune · 3 of 5 · ₹1.84 Cr · ₹1.12 Cr · On plan
- **Controls** — Stages certified before invoicing · Cost booked to the site that incurred it

**Job book · contract and callout work** · shown for a HVAC service firm

- **Figures across the top** — Open jobs 62 · Under AMC 41 · Out of contract 21 · Avg job margin 31%
- **Columns** — Job · Customer · Type · Value · State
- **Rows** — 4 worked examples, the first reading: JOB-2214 · Skyward Robotics · AMC · quarterly · ₹0 · Done
- **Controls** — Jobs closed with parts and time booked · Callouts invoiced without a signed sheet
...
Cash, sales, stock, profit and alerts on one screen, refreshed as work happens.
...
- **Rows** — 5 worked examples, the first reading: AG-1187 · Chase 14 unmatched payout lines, draft a claim for each · 14 drafted, none filed · Needs a yes
...
**Builder Data Model** — SPECIFIED — designed, not built

The tables and relationships a built application stands on: what a record is, which other records it points at, and which fields may not be empty. Kept separate from the builder because the data model is the expensive half to change later — a screen can be redrawn in an afternoon, a relationship that was wrong has to be migrated with all the rows already sitting in it.

**App Versioning & Release** — SPECIFIED — designed, not built

A built application has versions, somewhere to try one before it goes live, and a way back. Without this the person who assembled a screen is editing the live system at the exact moment they are still learning it, which is how a business loses a day of entries.

**Developer Console** — SPECIFIED — designed, not built

One place to see what the platform is doing for a given caller: keys issued, calls made, webhooks delivered or failed, functions run, and what each one cost. Somebody debugging an integration at two in the morning should not have to ask a person for a log.

**App Marketplace** — SPECIFIED — designed, not built

A directory of applications built on this platform that a business can install into its own company, with what each one may read and write shown before installation rather than discovered after it. Nothing installs without somebody first seeing the scope it is asking for.

**Robotic Process Automation** — SPECIFIED — designed, not built

Driving another system that offers no interface of its own by working its screens the way a person would. It is the least reliable way to connect anything, and worth having only when the alternative is somebody retyping figures every morning — so it is recorded here as a last resort with a run log proving what it actually did, never presented as equivalent to a real connection.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Developer platform · keys, calls and deliveries · last 24 h**

- **Figures across the top** — Calls served 48,201 · Failed deliveries 12 · Keys active 9 · Over rate limit 3
- **Columns** — Caller · What it may reach · Calls · State
- **Rows** — 4 worked examples, the first reading: courier-bridge · Orders · read · shipments · write · 21,480 · Healthy
- **Controls** — Calls inside the caller’s granted scope · Versions retired without an announced date

### The 1 rule this module must satisfy
...
**Product Backlog & Stories** — SPECIFIED — designed, not built

The queue of work that has not been started, written as something a person wants rather than a task somebody was handed, grouped under the larger outcome it belongs to and sized relative to the others. Sizing is deliberately relative and not in hours, because the one thing teams estimate consistently is whether a piece is bigger than another piece.

**Sprints & Boards** — SPECIFIED — designed, not built

A fixed period with a set of work committed to it, and a board showing where each piece has got to. The boundary is the point: work added midway is visible as having been added midway, so the difference between what was planned and what was delivered stays legible instead of being quietly absorbed. Planning at the start and a review at the end are part of the same record, not meetings held somewhere else.

**Velocity & Burndown** — SPECIFIED — designed, not built

How much this team actually finishes per period, and how the current one is tracking against what remains. Both are read from the board rather than typed by anybody, which matters because a progress figure a person types is a figure a person can round.

**Release Planning** — SPECIFIED — designed, not built

Which finished work goes out together and when, drawn from what the sprints have actually completed rather than from what was hoped for at the start. A release date derived from delivered work is the only kind that survives contact with the second sprint.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Sprint 14 · six working days remaining**

- **Figures across the top** — Committed 34 pts · Done 19 pts · Added mid-sprint 5 pts · Velocity, last 3 31 pts
- **Columns** — Story · Belongs to · Points · State
- **Rows** — 4 worked examples, the first reading: Goods receipt against a partial delivery · Purchase accuracy · 8 · Done
- **Controls** — Figures read from the board rather than typed · Mid-sprint additions shown as additions
...
**Meeting Scheduling** — SPECIFIED — designed, not built

Proposing a time, holding the slot, and letting people say whether it works before it is fixed. It reads the same availability the Calendar module keeps, so a meeting cannot be booked into a time the system already knows is taken.

**Participants, Co-hosts & Moderators** — SPECIFIED — designed, not built

Who is invited, who may run the session, and who may quiet it down. Three separate roles rather than one, because the person who owns the meeting is often not the person who should be managing a room of forty people while also presenting to them.

**Polls & Q&A** — SPECIFIED — designed, not built

A question put to everyone with the answers counted, and a queue of questions from the floor that can be ordered by how many people want the same one asked. Both outlive the call: the result is attached to the meeting record rather than disappearing when the window closes.

**Call & Meeting Analytics** — SPECIFIED — designed, not built

The record of contact — that a call or a meeting happened, with whom, about which account, and what came out of it — filed against the customer or the project it concerned. This is the half with lasting value: six months later nobody needs the recording, they need to know what was agreed and by whom.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Monthly production review · 14 invited**

- **Figures across the top** — Invited 14 · Accepted 11 · Attended 9 · Decisions recorded 4
- **Columns** — What was decided · Who it falls to · By when · State
- **Rows** — 4 worked examples, the first reading: Move the second line to two shifts · Production head · 30 Sep · Recorded
- **Controls** — Decisions attached to a record, not a recording · Outcomes surviving the call
...
**Events & Recurrence** — SPECIFIED — designed, not built

A dated entry with the people it concerns, and the rules for one that repeats. A single occurrence of a repeating event can be moved or cancelled without disturbing the rest of the series, which sounds small and is the difference between a calendar people trust and one they quietly stop using.

**Invitations, Availability & Time Zones** — SPECIFIED — designed, not built

Asking somebody to an event, tracking whether they answered, and showing when they are genuinely free. Every time is stored as an absolute moment and displayed in the reader’s own zone, so a meeting set across two countries means the same instant to both of them and survives a daylight-saving change landing between the booking and the day.

**Shared & Team Calendars** — SPECIFIED — designed, not built

A calendar belonging to a group rather than a person, with control over who may see a full entry and who may see only that the time is taken. The distinction matters: a team usually needs to know somebody is busy without being told what about.

**Resource Booking** — SPECIFIED — designed, not built

The things that get double-booked as often as people do — a room, a vehicle, a machine, a piece of equipment. Held as a bookable record with the same conflict checking an invitation gets, because a room with two meetings in it is the same failure as a person with two.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Team calendar · week of 21 September**

- **Figures across the top** — Events 37 · Across zones 2 · Room clashes 0 · Awaiting a reply 6
- **Columns** — Event · When · Who or what is held · State
- **Rows** — 4 worked examples, the first reading: Production review · monthly · Mon 10:00 IST · Meeting room 1 · Confirmed
- **Controls** — Times stored absolute and shown local · Events moved by a daylight-saving change
...
**Shared Inbox** — SPECIFIED — designed, not built

One mailbox several people work, with it visible who is dealing with what so two of them do not answer the same message differently within a minute of each other. An address a business publishes belongs to the business, not to whoever happens to have the password for it.

**Folders, Labels & Search** — SPECIFIED — designed, not built

Filing, tagging and finding, including inside what is attached. Search is listed last in the specification and is the one people actually use all day, which is worth saying out loud when deciding what to build first.

**Filters & Rules** — SPECIFIED — designed, not built

What happens to a message automatically on arrival: filed, tagged, sent on to somebody else, or pulled to the top. Every rule that fired is visible on the message, because a mail that quietly vanished into a folder somebody forgot they created is indistinguishable from a mail that was never sent.

**Signatures & Auto-reply** — SPECIFIED — designed, not built

The block appended to what goes out, and the answer sent while somebody is away. The away message names who to contact instead, so an absence routes the sender somewhere rather than simply telling them to wait.

**Mail Admin Controls** — SPECIFIED — designed, not built

Who may open which mailbox, what is retained and for how long, and what may leave the organisation. This is the half that makes a shared mailbox safe to use for anything a business would mind losing.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Shared inbox · orders@ · this morning**

- **Figures across the top** — Unread 23 · Being handled 6 · Answered today 41 · Auto-filed 88
- **Columns** — From · Subject · Filed by · State
- **Rows** — 4 worked examples, the first reading: A wholesale buyer · Revised PO for the October run · Rule · B2B · Being handled
- **Controls** — Messages showing which rule filed them · Silent redirections
...
**Word Processor** — SPECIFIED — designed, not built

Writing a document inside the system so it is filed against the record it concerns instead of living on somebody’s laptop. The value is not the editor, which is a solved and crowded problem — it is that the document is attached to the order, the case or the person it is actually about.

**Presentations** — SPECIFIED — designed, not built

Slides, for the same reason and with the same honest caveat: the point is where the file lives and what it is linked to, not that this is a better tool than the one already on every desk.

**Notes** — SPECIFIED — designed, not built

Short-form writing that is not a document — a thought against a customer, a decision against a project. The format most used and least specified, which is usually a sign it should be built before the two above it.

**Co-editing & Track Changes** — SPECIFIED — designed, not built

Two people in the same document without one of them overwriting the other, and a visible record of who changed what so an edit can be accepted or undone. This is the genuinely hard part of all three applications above, and the part a business actually notices missing.

**Version Recovery** — SPECIFIED — designed, not built

Getting back what a document said before somebody changed it. Listed once in the specification under storage and worth its own line here, because it is the feature nobody asks for until the first afternoon it is needed.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Documents · filed against the records they concern**

- **Figures across the top** — Documents 1,284 · Co-edited this week 19 · Awaiting review 7 · Recovered 2
- **Columns** — Document · Filed against · Last change · State
- **Rows** — 4 worked examples, the first reading: Supply agreement · v4 · Party · a components maker · 2 days ago · In review
- **Controls** — Documents reachable from the record they are about · Documents whose only address is a folder
...
**Courses & Lessons** — SPECIFIED — designed, not built

The material somebody has to work through, in the order it makes sense, in the language the person being taught actually reads. Built over the staff records that already exist rather than a second list of people maintained beside them.

**Assessments** — SPECIFIED — designed, not built

A check that something was understood, at the end of a course or as part of hiring. The same mechanism serves both, which is why the specification lists it twice and this design does not build it twice.

**Learning Paths & Progress** — SPECIFIED — designed, not built

A sequence of courses for a role, and who is where in it. The record that matters for compliance is this one: not that training was offered, but that a named person completed it on a date, and that the record can be produced when somebody asks for it.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Learning · who has been taught what**

- **Figures across the top** — Courses 18 · Completions this month 64 · Overdue 9 · Expiring in 30 days 5
- **Columns** — Course · Required for · Completed · State
- **Rows** — 4 worked examples, the first reading: Machine safety · line 2 · 12 operators · 12 of 12 · Current
- **Controls** — Completions dated against a named person · Training offered counted as training completed
...
**Triggers & Actions** — SPECIFIED — designed, not built

The two halves of any integration: something that starts it, and something it then does. Kept as one app because they are meaningless apart — the whole design is that any trigger can drive any action without either knowing what the other is.

**Connector Library** — SPECIFIED — designed, not built

A described connection to a named outside system, with how it proves who it is, how often it may be called and its quirks written down once instead of rediscovered by each person who integrates it. A connector nobody can run without credentials still has value as a specification of what connecting would take.

**Integration Webhooks & APIs** — SPECIFIED — designed, not built

The framework’s own way in and out, distinct from the product surface in the Developer Platform: this is how a connector receives a push from the far side and how it calls back. Separated because the two have different audiences, and conflating them is how an internal mechanism accidentally becomes a public promise.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Integration platform · connectors and what they may touch**

- **Figures across the top** — Connectors 11 · Runs today 1,940 · Failed 6 · Scope changes 0
- **Columns** — Connector · Trigger · Action · State
- **Rows** — 4 worked examples, the first reading: Courier · rate and book · Order marked ready · Book shipment, write AWB · Healthy
- **Controls** — Runs inside the scope granted at install · Connectors that widened their own reach
...
**Second Proof at Sign-in** — SPECIFIED — designed, not built

A second proof at sign-in beyond a password, with recovery codes for the phone that gets lost and a policy for who must use it. The smallest item in this module and the only genuinely urgent one: a system reachable from the internet with a single factor is a system waiting for one reused password to matter.

**Password & Secret Management** — SPECIFIED — designed, not built

Where shared credentials live so they stop living in a message thread, with who may retrieve which one recorded. This system never asks for a marketplace, bank or account password of its own; this app is about the credentials a business already has to hold for other things, and the fact that they are currently held badly.

**IT Service Desk** — SPECIFIED — designed, not built

Internal requests — a laptop, an account, access to something — as tickets with an owner and a resolution. The same shape as the customer Helpdesk in CRM, pointed inward, and honestly a different product from the one this system is for.

**Security Analytics** — SPECIFIED — designed, not built

Sign-ins, failures and unusual patterns, read from the audit trail that already records everything. It needs no new capture because the record is already being kept — what is missing is anybody looking at it, which is what this app would be.

### The 1 specified screen

Not a picture — the columns, the rows and the controls, written down so a built screen can be compared against something.

**Identity & IT · sign-in and what the trail shows**

- **Figures across the top** — Accounts 63 · With a second factor 63 · Failed sign-ins, 24 h 11 · Open IT requests 4
- **Columns** — Signal · What was seen · When · State
- **Rows** — 4 worked examples, the first reading: Repeated failures · one account · 9 attempts, then success · 04:12 · Reviewed · travel
- **Controls** — Accounts reachable from the internet with one factor · Sign-ins present in the audit trail
...
# Part three — what it runs on, and what would replace it
...
# Part four — what changes without a developer, and what never changes
