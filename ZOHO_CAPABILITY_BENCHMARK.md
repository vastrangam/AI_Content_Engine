...
| [CRM](https://www.zoho.com/en-in/crm/?ireft=nhome&src=all-products-phome) | COVERED | CRM & Customer 360 | IMPLEMENTED | Lead to won and the lifetime after it, in one record. |
| [Bigin](https://www.bigin.com/en-in/?ireft=nhome&src=all-products-phome) | COVERED | CRM & Customer 360 | IMPLEMENTED | A smaller packaging of the same capability class. Packaging is a pricing decision, not a second capability. |
| [POS](https://www.zoho.com/en-in/pos/?ireft=nhome&src=all-products-phome) | COVERED | POS | IMPLEMENTED | Counter billing drawing on the same stock number as every other channel. |
...
| [Vikra Seller](https://www.vikra.com/en-in/seller/) | COVERED | Marketplace OMS, Listing & Catalog Manager | IMPLEMENTED | Selling through somebody else’s marketplace is module 15’s subject. |
| [Desk](https://www.zoho.com/en-in/desk/?ireft=nhome&src=all-products-phome) | COVERED | Helpdesk & Live Chat, Knowledge Base | IMPLEMENTED | Tickets tied to the order they are about, and the knowledge base beside them. |
| [SalesIQ](https://www.zoho.com/salesiq/?ireft=nhome&src=all-products-phome) | COVERED | Helpdesk & Live Chat | IMPLEMENTED | Live chat is named. Website visitor tracking and lead scoring from browsing behaviour are named nowhere, so this is covered at the name and probably not at the depth — which is exactly the distinction the unread pages would settle. |
...
| [Procurement](https://www.zoho.com/procurement/?ireft=nhome&src=all-products-phome) | COVERED | Procurement, Vendor Management | IMPLEMENTED | Named in module 07, and both are browser apps today. |
...
| [Analytics](https://www.zoho.com/analytics/?ireft=nhome&src=all-products-phome) | COVERED | Report Builder, CEO Dashboard | IMPLEMENTED | Both are named and both open in a browser. Neither queries the database: the registry carries CAP-ANALYTICS as SPECIFIED, and the prototype computes over an in-page store. |
...
| [Analytics — dashboard builder](https://www.zoho.com/analytics/online-dashboard-builder.html?ireft=nhome&src=all-products-phome) | COVERED | CEO Dashboard, Report Builder, Excel Dashboard Builder | IMPLEMENTED | Three named apps, two of them browser prototypes today. |
