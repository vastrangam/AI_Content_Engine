...
'06': { t:'Courier network · rates, failures, COD',
  ...
  r:[['Courier A','Metro','₹42',['96%','g'],'4'],
     ...
     ['Own delivery','Surat local','₹18',['99%','g'],'0']],
  b:[['NDR rescued before RTO',71],['COD reaching bank in 5 days',88]] },

'07': { t:'Stock · one number, every godown',
  k:[['Designs live','2,418',''],['Below reorder','37','r'],['Dead over 120 d','₹4.6 L','a'],['Value at cost','₹2.09 Cr','']],
  c:['Design','Item','Godown 1','Godown 2','Free'],
  r:[['VG-1180','Teal chinon anarkali','214','60',['274','g']],
     ['VS-2204','Red georgette saree','1,880','240',['2,120','g']],
     ['VK-3310','Pink cotton kurta set','96','0',['74','a']],
     ['FAB-CH42','Chinon greige \u00b7 metres','18','4',['9','r']]],
...
'16': { t:'The record · append-only, nothing removable',
  ...
  r:[['14:22','a.deshpande','Credit limit raised · Rajmandir','Surat office'],
     ['14:19','system','GST invoice VS-INV-4471 issued','Website'],
