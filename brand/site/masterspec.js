...
const SECTIONS = [
  ...
  S(2, 'S02', 'Master application hub', [
    ...
    B('People', [
      ...
      ['Performance', 'APP-16-03'], ['Learning', 'APP-29-01'], ['Employee engagement', 'APP-16-06'],
    ]),
    B('Collaboration', [
      ...
      ['Calendar', 'APP-26-01'], ['Chat', 'APP-20-06'],
      ['Meetings', null, 'Needs live audio/video infrastructure.'],
      ['Documents', 'APP-04-02'], ['Spreadsheets', 'APP-21-04'], ['Presentations', 'APP-28-02'],
      ['Notes', 'APP-28-03'], ['Team workspace', 'APP-20-01'], ['Shared inbox', 'APP-27-01'],
    ]),
    B('Projects', [
      ['Project management', 'APP-20-01'], ['Agile management', 'APP-24-02'],
    ...
    B('Data and analytics', [
      ...
      ['Data warehouse', 'APP-21-06'], ['Reports', 'APP-21-02'],
    ...
    B('Automation', [
      ...
      ['RPA', 'APP-23-09'], ['Process management', 'APP-20-05'], ['Custom applications', 'APP-23-04'],
    ]),
    B('Developer platform', [
      ['Low-code builder', 'APP-23-04'], ['APIs', 'APP-23-01'], ['Webhooks', 'APP-23-02'], ['Functions', 'APP-23-03'],
      ['Developer console', 'APP-23-07'], ['App marketplace', 'APP-23-08'],
    ]),
    B('AI', [
    ...
    B('Security and IT', [
      ...
      ['MFA', 'APP-31-01'], ['Password management', 'APP-31-02'],
      ['Endpoint management', null, 'Needs an agent installed on every device — a fleet, not a repository.'],
      ['IT service management', 'APP-31-03'], ['Monitoring', null, 'Needs something deployed to monitor.'],
      ['Security analytics', 'APP-31-04'],
    ]),
  ...
  S(3, 'S03', 'CRM', [
    B('Modules', [
      ...
      ['Meetings', 'APP-25-01'], ['Notes', 'APP-04-01'], ['Attachments', 'APP-04-02'],
      ['Campaigns', 'APP-17-02'], ['Territories', 'APP-04-05'], ['Forecasts', 'APP-06-01'],
      ['Custom modules', 'APP-23-04'],
    ]),
    ...
    B('Sales functionality', [
      ...
      ['Sales targets', 'APP-13-03'], ['Territory management', 'APP-04-05'],
    ...
    B('Customer 360', [
      ...
      ['Calls', 'APP-25-04'], ['Meetings', 'APP-25-04'], ['Notes', 'APP-04-01'],
  ...
  S(4, 'S04', 'Marketing', [
    ...
    B('Social media', [
      ...
      ['Engagement', 'APP-17-09'], ['Analytics', 'APP-17-01'],
    ]),
    B('Landing pages', [
    ...
    B('Webinars', [
      ...
      ['Polls', 'APP-25-03'], ['Q&A', 'APP-25-03'], ['Chat', 'APP-20-06'],
  ...
  S(13, 'S13', 'HR', [
    ...
    B('Learning', [
      ['Courses', 'APP-29-01'], ['Lessons', 'APP-29-01'], ['Training', 'APP-29-01'], ['Assessments', 'APP-29-02'],
      ['Certifications', 'APP-09-02'], ['Learning paths', 'APP-29-03'],
      ['Employee progress', 'APP-29-03'],
    ]),
  ]),
  ...
  S(14, 'S14', 'Recruitment', [
    B('Recruitment', [
      ...
      ['Assessments', 'APP-29-02'], ['Hiring workflows', 'APP-20-05'],
  ...
  S(16, 'S16', 'Project management', [
    B('Projects', [
      ...
      ['Calendar', 'APP-26-01'], ['Timesheets', 'APP-20-02'], ['Issues', 'APP-20-01'],
  ...
  S(17, 'S17', 'Agile development', [
    B('Agile', [
      ['Product backlog', 'APP-24-01'], ['Epics', 'APP-24-01'], ['User stories', 'APP-24-01'],
      ['Sprints', 'APP-24-02'], ['Scrum boards', 'APP-24-02'], ['Story points', 'APP-24-01'],
      ['Sprint planning', 'APP-24-02'], ['Sprint reviews', 'APP-24-02'], ['Retrospectives', 'APP-24-02'],
      ['Velocity', 'APP-24-03'], ['Burndown', 'APP-24-03'], ['Release planning', 'APP-24-04'],
  ...
  S(18, 'S18', 'Document management', [
    B('Storage', [
      ...
      ['Document recovery', 'APP-28-05'], ['Desktop synchronization', null, 'Needs a desktop client installed on each machine.'],
      ['Mobile access', null, 'Needs a mobile app and the store accounts to release it.'],
    ]),
    B('Document applications', [
      ['Word processor', 'APP-28-01'], ['Spreadsheet', 'APP-21-04'],
      ['Presentation', 'APP-28-02'], ['Notes', 'APP-28-03'],
    ]),
    B('Document features', [
      ['Collaboration', 'APP-28-04'], ['Comments', 'APP-20-06'], ['Track changes', 'APP-28-04'],
  ...
  S(19, 'S19', 'Email', [
    B('Business email', [
      ...
      ['Filters', 'APP-27-03'], ['Folders', 'APP-27-02'], ['Labels', 'APP-27-02'], ['Search', 'APP-27-02'],
      ['Attachments', 'APP-27-02'], ['Signatures', 'APP-27-04'], ['Vacation responder', 'APP-27-04'],
      ['Email rules', 'APP-27-03'], ['Email forwarding', 'APP-27-03'],
      ['Email security', null, 'SPF, DKIM and DMARC are DNS on a domain nobody has pointed yet.'],
      ['Admin controls', 'APP-27-05'],
    ]),
  ]),
  ...
  S(20, 'S20', 'Calendar', [
    B('Calendar', [
      ['Events', 'APP-26-01'], ['Recurring events', 'APP-26-01'], ['Invitations', 'APP-26-02'],
      ['Shared calendars', 'APP-26-03'], ['Team calendars', 'APP-26-03'], ['Resource booking', 'APP-26-04'],
      ['Reminders', 'APP-01-04'], ['Availability', 'APP-26-02'], ['Time zones', 'APP-26-02'],
      ['Scheduling', 'APP-26-02'],
  ...
  S(22, 'S22', 'Video meetings', [
    B('Meetings', [
      ...
      ['Chat', 'APP-20-06'], ['Polls', 'APP-25-03'], ['Q&A', 'APP-25-03'],
      ['Participant management', 'APP-25-02'], ['Co-hosts', 'APP-25-02'], ['Moderators', 'APP-25-02'],
      ['Scheduling', 'APP-25-01'],
  ...
  S(24, 'S24', 'Low-code app builder', [
    B('Builder', [
      ['Drag-and-drop UI', 'APP-23-04'], ['Forms', 'APP-04-04'], ['Tables', 'APP-21-04'],
      ['Reports', 'APP-21-02'], ['Dashboards', 'APP-21-01'], ['Pages', 'APP-17-05'],
      ['Databases', 'APP-23-05'], ['Relationships', 'APP-23-05'], ['Workflows', 'APP-20-05'],
      ['Approvals', 'APP-20-03'], ['Permissions', 'APP-01-01'], ['Portals', 'APP-04-01'],
      ['Custom domains', null, 'Needs a registrar and a host.'],
      ['APIs', 'APP-23-01'], ['Webhooks', 'APP-23-02'], ['Custom functions', 'APP-23-03'],
      ['Scripting', 'APP-23-03'], ['App deployment', null, 'Needs somewhere to deploy to.'],
      ['App versioning', 'APP-23-06'],
    ]),
  ]),
  ...
  S(25, 'S25', 'Workflow automation', [
    B('Trigger types', [
      ...
      ['Webhook', 'APP-23-02'], ['API', 'APP-23-01'],
    ...
    B('Actions', [
      ...
      ['Request approval', 'APP-20-03'], ['Call webhook', 'APP-23-02'],
      ['Execute function', 'APP-23-03'], ['Update another application', 'APP-20-05'],
  ...
  S(26, 'S26', 'Integration platform', [
    B('Integration', [
      ['Triggers', 'APP-30-01'], ['Actions', 'APP-30-01'], ['Conditions', 'APP-20-05'],
      ['Multi-step workflows', 'APP-20-05'], ['Webhooks', 'APP-30-03'], ['APIs', 'APP-30-03'],
      ...
      ['Custom connectors', 'APP-30-02'], ['Data transformation', 'APP-03-04'],
  ...
  S(27, 'S27', 'Data preparation', [
    B('Data prep', [
      ...
      ['Enrichment', 'APP-21-07'], ['Data masking', 'APP-01-06'],
      ['Data pipelines', 'APP-21-07'], ['Scheduled imports', 'APP-20-05'],
      ['Export', 'APP-03-04'],
    ]),
  ]),
  ...
  S(28, 'S28', 'Business analytics', [
    B('Data sources', [
      ...
      ['APIs', 'APP-23-01'], ['CSV', 'APP-03-04'], ['Excel', 'APP-21-04'],
    ]),
    B('Visualization', [
      ...
      ['Maps', 'APP-21-08'], ['Pivot tables', 'APP-21-04'], ['Cohort analysis', 'APP-21-02'],
    ...
    B('Report features', [
      ...
      ['Data blending', 'APP-21-03'], ['Embedded analytics', 'APP-21-09'],
    ]),
  ]),
