...
{n:'04',name:'E-commerce / OMS',icon:'globe',tag:'Every marketplace and your own website, one queue',
 ...
 apps:[['Marketplace OMS','globe','Every marketplace and every storefront in one order queue — Amazon, Flipkart, Myntra, Meesho, Ajio, Nykaa and JioMart alongside Shopify, WooCommerce, Magento, Wix and your own custom site. Process them all together, channel-wise, or product-wise.'],
       ...
       ['Channels & Storefronts','sync','Connect a channel once and it stays in step: catalogue out, price out, stock out, orders in. Seven marketplaces and any website platform — Shopify, WooCommerce, Magento, BigCommerce, Wix or a custom site over its own API — each switchable without touching your data.']]},
...
{n:'07',name:'Inventory & Catalog',icon:'layers',tag:'One number everyone trusts',
 ...
 apps:[['Stock','layers','Live quantity by SKU, location and stage, with reorder alerts, batches, kits and dead-stock.'],
       ['Catalog / PIM','tag','One product record — attributes, images, pricing and HSN — pushed to every marketplace and to your Shopify or WooCommerce storefront, and scored for each channel’s rules before it lists.']]},
