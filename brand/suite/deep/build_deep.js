...
const APPS = [
  ...
  { dir: 'crm',         out: 'crm',         title: 'CRM & Customer 360', libs: ['m02lib.js', 'm02views.js'] },
  { dir: 'docs',        out: 'docs',        title: 'Documents & eSign', libs: ['m02lib.js', 'm02views.js'] },
  { dir: 'helpdesk',    out: 'helpdesk',    title: 'Helpdesk & Live Chat', libs: ['m02lib.js', 'm02views.js'] },
  { dir: 'm02unified',  out: 'm02',         title: 'Module 02 \u00b7 CRM', libs: ['m02lib.js', 'm02views.js', '../xlsx.js'] },
