...
var CONFIG={
  ...
  wiring:[
    ...
    {f:'Stock movement',s:'Inventory (fabric &amp; finished)',h:'Reserved when the order is confirmed, released when it is cancelled'},
    ...
    {f:'Abandoned carts',s:'vastrangam.com',h:'Carts with no order against them, aged in days'},
