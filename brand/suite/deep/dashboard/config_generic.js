...
var CONFIG={
  ...
  wiring:[
    {f:'Net sales',s:'Sales / Orders module',h:'Every invoice added up, minus every credit note (return), for the period you picked'},
    {f:'Return %',s:'Sales returns',h:'Returns ÷ gross sales, worked out separately for each channel'},
    {f:'Net profit',s:'Sales + Purchase + Payroll + Accounts',h:'Net sales − purchases − making cost / wages − running expenses'},
    {f:'Cash + bank',s:'Accounts / Ledger',h:'Opening balance + everything earned or spent since — a true balance, not a period figure'},
    ...
    {f:'Stock value',s:'Inventory module',h:'Quantity on hand × cost price, item by item'},
    {f:'Running out',s:'Inventory + Item master',h:'Any item where quantity has fallen to or below its reorder point'},
    {f:'Pieces made / making cost',s:'Manufacturing / Production',h:'Output and wages booked by the production floor for the period'},
  ...
  wiringIn:[
    {from:'Sales & Orders',what:'Invoices, credit notes, channel tags'},
    ...
    {from:'Accounts',what:'Opening balances, expenses, receipts and payments'}]
};
