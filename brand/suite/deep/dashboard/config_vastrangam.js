...
var CONFIG={
  ...
  wiring:[
    {f:'Net sales',s:'E-commerce / OMS + Sales',h:'Myntra / Flipkart / website orders added up, minus every return and cancellation, for the period you picked'},
    {f:'Return %',s:'E-commerce / OMS (returns)',h:'Returns ÷ gross sales, per channel — Myntra and Flipkart are tracked separately because their return behaviour is different'},
