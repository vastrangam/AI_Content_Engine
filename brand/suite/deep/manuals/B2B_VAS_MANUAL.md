# B2B & Credit — Complete Manual
### Medhava · Vastrangam — ethnic-wear D2C + marketplace
**Module 03 · Sales — App 2 of 5**
...
The buy-in-bulk side of selling, and two rules that decide whether it makes
...
WHAT YOU NEED
  ...
  The whole app is ONE file: B2B_Credit.html
  About 74 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file B2B_Credit.html — usually in your Downloads folder.
  ...
  2. Double-click B2B_Credit.html.
...
ON A MAC
  1. Find B2B_Credit.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click B2B_Credit.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save B2B_Credit.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap B2B_Credit.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     B2B & Credit directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save B2B_Credit.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now B2B & Credit has its own icon on your home screen.
...
WHAT THE SCREEN SHOWS
  ...
  Alternatives available       How many different options you can pick from
                               across those capabilities — 74 in this app.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_b2b_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — B2B_Credit.html AND the backup.
  3. On the new device: open B2B_Credit.html, then "Backup & Health" →
...
Every time B2B & Credit opens, it quietly checks its own arithmetic — 35
...
language, so you can read what was actually checked. For example:
  ...
  · "an order that would break the limit is refused, not approved"
...
**File you need:** `B2B_Credit.html` · opens by double-click · works offline · 35 self-tests
**Companion app in this module:** D2C Sales · Export · POS · Quotes & Proforma
