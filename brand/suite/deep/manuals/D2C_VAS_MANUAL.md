# D2C Sales — Complete Manual
### Medhava · Vastrangam — ethnic-wear D2C + marketplace
**Module 03 · Sales — App 1 of 5**
...
Every order from your own storefront in one pipeline: New → Confirmed →
...
For Vastrangam this is the channel worth protecting: no marketplace
commission, no 14% return rate, and the customer is yours rather than the
platform’s.
...
arithmetic 35 different ways every time it starts.
...
WHAT YOU NEED
  ...
  The whole app is ONE file: D2C_Sales.html
  About 72 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file D2C_Sales.html — usually in your Downloads folder.
...
ON A MAC
  1. Find D2C_Sales.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click D2C_Sales.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save D2C_Sales.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap D2C_Sales.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     D2C Sales directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save D2C_Sales.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now D2C Sales has its own icon on your home screen.
...
WHERE THE ORDERS ARE
  ...
  In ethnic wear a refused parcel costs the courier fee both ways and the piece comes back creased.
...
to win back, and almost nobody chases it.
  ...
  A saree left in a cart this week is still warm — she remembers the wedding she wanted it for. After a week the occasion has usually passed.
...
WHAT THE SCREEN SHOWS
  ...
  Alternatives available       How many different options you can pick from
                               across those capabilities — 71 in this app.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_d2c_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — D2C_Sales.html AND the backup.
  3. On the new device: open D2C_Sales.html, then "Backup & Health" →
...
**File you need:** `D2C_Sales.html` · opens by double-click · works offline · 35 self-tests
**Companion app in this module:** B2B & Credit · Export · POS · Quotes & Proforma
