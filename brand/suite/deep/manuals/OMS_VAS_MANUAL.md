...
WHAT EACH MARKETPLACE ACTUALLY PAYS YOU
  ...
  ₹4,999 on Myntra is not ₹4,999. Less 30% commission and ₹79 shipping, it is about ₹3,424 — and that is before a single parcel comes back.
...
Everything still to go out, from every panel, in ONE list.
  ...
  That is the whole point. Amazon gives you 12 hours. Flipkart and Myntra give you 24. Ajio and Nykaa give you 48.
...
late right now.
  ...
  Myntra will almost always be biggest by gross. After 30% commission and a 20% return rate it is frequently not biggest by money in the bank. Meesho at 12% often beats it.
...
"LEVEL THE PRICE"
  ...
  A saree left at ₹4,499 from a Myntra event while Ajio still shows ₹5,299 gets the Ajio listing pushed down — and Ajio is a 28% channel you are paying to be visible on.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_oms_vastrangam_v1".
