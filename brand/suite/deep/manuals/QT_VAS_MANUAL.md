# Quotes & Proforma — Complete Manual
### Medhava · Vastrangam — ethnic-wear D2C + marketplace
**Module 03 · Sales — App 5 of 5**
...
WHAT YOU NEED
  ...
  The whole app is ONE file: Quotes_Proforma.html
  About 73 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file Quotes_Proforma.html — usually in your Downloads folder.
  ...
  2. Double-click Quotes_Proforma.html.
...
ON A MAC
  1. Find Quotes_Proforma.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click Quotes_Proforma.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save Quotes_Proforma.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap Quotes_Proforma.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Quotes & Proforma directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save Quotes_Proforma.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Quotes & Proforma has its own icon on your home screen.
...
════════════════════════════════════════════════════════════════════════
  ...
  LEFT MENU     Five screens in three groups:
...
WHAT THE HAGGLING COST  (bottom panel)
  ...
  One quote losing 10% is a negotiation. Every quote losing 10% is a price list that is 10% too high — and nobody notices unless somebody keeps the first offer.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_qt_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — Quotes_Proforma.html AND the backup.
  3. On the new device: open Quotes_Proforma.html, then "Backup & Health" →
...
Every time Quotes & Proforma opens, it quietly checks its own arithmetic — 34
...
language, so you can read what was actually checked. For example:
  ...
  · "a quote past its validity reads as expired on its own"
...
**File you need:** `Quotes_Proforma.html` · opens by double-click · works offline · 34 self-tests
**Companion app in this module:** D2C Sales · B2B & Credit · Export · POS
