# Module 02 · All three apps in one — Complete Manual
### Medhava · Vastrangam — its own buyers, mills and marketplaces
**Module 02 · CRM — App 4 of 4**
...
════════════════════════════════════════════════════════════════════════
   ...
   M E D H A V A  ·  MODULE 02 · ALL THREE APPS IN ONE
...
WHAT YOU NEED
  ...
  The whole app is ONE file: VASTRANGAM_M02_App04_All_Three_In_One.html
  About 177 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file VASTRANGAM_M02_App04_All_Three_In_One.html — usually in your Downloads folder.
  ...
  2. Double-click VASTRANGAM_M02_App04_All_Three_In_One.html.
...
ON A MAC
  1. Find VASTRANGAM_M02_App04_All_Three_In_One.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click VASTRANGAM_M02_App04_All_Three_In_One.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save VASTRANGAM_M02_App04_All_Three_In_One.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap VASTRANGAM_M02_App04_All_Three_In_One.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Module 02 · All three apps in one directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save VASTRANGAM_M02_App04_All_Three_In_One.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Module 02 · All three apps in one has its own icon on your home screen.
...
WHAT THE SCREEN SHOWS
  ...
  Capabilities used            The outside things this app can talk to.
                               Module 02 · All three apps in one uses 7.
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — VASTRANGAM_M02_App04_All_Three_In_One.html AND the backup.
  3. On the new device: open VASTRANGAM_M02_App04_All_Three_In_One.html, then "Backup & Health" →
...
Every time Module 02 · All three apps in one opens, it quietly checks its own arithmetic — 49
...
**File you need:** `VASTRANGAM_M02_App04_All_Three_In_One.html` · opens by double-click · works offline · 49 self-tests
