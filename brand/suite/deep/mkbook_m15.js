'use strict';
/* Module 15 · E-commerce / OMS — two app books (× 2 editions) + the module book, all through
...
const MOD = require('./module_m15.js');
...
/* ─── module book ─── */
function moduleBook() {
  const P = bookBuilder('E-commerce / OMS', 'Module 15');
  const pages = [];
  ...
  pages.push(`<section class="pg cover"><div class="cwrap">
    <div class="logo">${mark} Medhava</div><div class="ed">Module 15 of 21</div>
    ...
    <p class="lede">Module 05 recorded the sale. Module 15 is about getting it out of the door. Seven seller panels collapsed into one queue with one clock, and one order book across every channel where the warehouse is chosen for you and the delivery date is worked out rather than promised.</p>
  ...
  pages.push(P(`<h2>What this module is</h2>
    <p class="big">Module 05 was about <b>recording the sale</b>. Module 15 is about <b>getting it out of the door</b> — and it is where multi-channel businesses actually break.</p>
...
for (const key of ['oms', 'ordman']) {
  ...
  for (const [ed, tag, cfgFile, edition, co] of [
    ...
    const c = Object.assign({}, s, {
      tag, edition, co, cfg,
      moduleLine: 'Module 15 · E-commerce / OMS — App ' + s.n + ' of 2',
...
jobs.push({ html: moduleBook(), out: 'Medhava_Module_15_Ecommerce_OMS.pdf' });
render(jobs);
