'use strict';
/* Module 21 · Dashboard & BI — the illustrated process PDFs.
...
function appBook(c) {
  ...
  pages.push(cover(c, c.app, c.sub, `Module 21 · Dashboard &amp; BI — App ${c.n} of 4`, c.lede, c.badges));
  ...
  pages.push(P(`<h2>Where this app sits</h2>
    <p>Every Medhava app stands on <b>one shared Data Core</b>: Item/SKU, Party, Stock, Ledger/Voucher and Order. Each module writes into it; Module 21 is the module that reads it.</p>
...
const APPS = [
  ...
  { dir: 'm21unified', tag: 'UNI', n: 4, app: 'Module 21 · All three apps in one', ring: 'uni', pages: uniPages,
...
/* ══════════════════ the module book ══════════════════ */
function moduleBook() {
  const P = bookBuilder('Dashboard & BI', 'Module 21');
  ...
  pages.push(`<section class="pg cover"><div class="cwrap">
    ...
    <div class="ed">Module 21 of 21</div>
    <h1>Dashboard &amp; BI</h1>
  ...
  pages.push(P(`<h2>What this module is</h2>
    <p class="big">Module 21 is the <b>seeing</b> layer of Medhava. It reads what every other module writes and turns it into three things: a screen that tells you where you stand, a tool that answers any other question, and one honest set of figures across every company you run.</p>
  ...
  pages.push(P(`<h2>How the apps sit on the Data Core</h2>
    <p>Every Medhava module writes into one shared core. Module 21 is the module that reads it.</p>
    <div class="wire2"><div class="core"><b>UNIFIED DATA CORE</b><span>Item · Party · Stock · Ledger · Order</span></div>
      <div class="ring">
    ...
    <div class="good"><b>"One business, one brain" is this table.</b> Every other ERP problem — stock that disagrees between channels, a profit figure nobody can reproduce, a report that contradicts the dashboard — comes from having two copies of one of these five things. Medhava has one of each, and Module 21 proves it by reading them.</div>`));
  ...
  return doc(P.render(pages[0]), 'Medhava · Module 21 · Dashboard & BI');
}
...
(async () => {
  ...
  jobs.push({ html: moduleBook(), out: 'Medhava_Module_21_Dashboard_BI' });
