'use strict';
/* Generates MANUAL.md for each app × each edition of Module 04 — eight in all.
   ...
   Module 21's shared idea was the two dials — period and company. Module 04 has neither.
...
const COMMON = {
  ERP: {
    ...
    sentDoc: 'D-2003', sentDocTitle: 'NDA', sentSigner: 'Vishitasompura Nair',
...
const APPS = [
  ...
  { tag: 'U2', dir: 'm04unified', screens: U2_SCREENS, app: 'Module 04 · All three apps in one',
...
for (const a of APPS) {
  for (const edKey of ['ERP', 'VAS']) {
    ...
    const c = Object.assign({}, COMMON[edKey], {
      ...
      file: `${ED[edKey]}_M04_App0${a.n}_${a.slug}.html`,
      key: 'medhava_' + a.key + (edKey === 'ERP' ? 'erp' : 'vastrangam') + '_v1',
      companion: a.companion,
      module: 'Module 04 · CRM — App ' + a.n + ' of 4',
