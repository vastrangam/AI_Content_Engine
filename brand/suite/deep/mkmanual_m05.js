'use strict';
/* Generates MANUAL.md for all five apps × both formats of Module 05 · Sales. */
...
/* ─────────── the ten builds ─────────── */
const base = { module: 'Module 05 · Sales', liveFrom: 'your other systems' };
const V = {
  D2C_ERP: { app: 'D2C Sales', co: 'Acme Corp', file: 'D2C_Sales.html', kb: 72, tests: 35,
    ...
    module: 'Module 05 · Sales — App 1 of 5', capCount: 7, altCount: 71, liveFrom: 'your other systems',
...
const B = (id, app, file, kb, tests, n, cap, alt, screens, intro, extra) => {
  const g = Object.assign({ app, file, kb, tests, screens, intro,
    module: 'Module 05 · Sales — App ' + n + ' of 5', capCount: cap, altCount: alt,
