'use strict';
/* Generates MANUAL.md for each app × each edition of Module 21 — eight in all.
...
const APPS = [
  ...
  { tag: 'UNI', screens: UNI_SCREENS, app: 'Module 21 · All three apps in one', file: 'Module_21_All_In_One.html',
...
for (const a of APPS) {
  for (const edKey of ['ERP', 'VAS']) {
    ...
    const c = Object.assign({}, COMMON[edKey], {
      ...
      module: 'Module 21 · Dashboard & BI — App ' + a.n + ' of 4',
    ...
    const core = fs.readFileSync(path.join(__dirname, { DASH: 'dashboard', REP: 'reports', GRP: 'groupcons', UNI: 'm21unified' }[a.tag], 'core.js'), 'utf8');
