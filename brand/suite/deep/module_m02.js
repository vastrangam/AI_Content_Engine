'use strict';
/* Module 02 — the single description of the module. The packager builds the ZIPs from it AND
...
module.exports = {
  ...
  apps: [
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M02_App1_CRM_ERP.pdf', VASTRANGAM: 'out/Medhava_M02_App1_CRM_VAS.pdf' },
    ...
    },
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M02_App2_DOC_ERP.pdf', VASTRANGAM: 'out/Medhava_M02_App2_DOC_VAS.pdf' },
    ...
    },
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M02_App3_HD_ERP.pdf', VASTRANGAM: 'out/Medhava_M02_App3_HD_VAS.pdf' },
  ...
  unified: {
    n: '04', slug: 'All_Three_In_One', name: 'Module 02 · All three apps in one', screens: 14, tests: 49,
    html: { MEDHAVA: 'out/m02_ERP.html', VASTRANGAM: 'out/m02_Vastrangam.html' },
    manual: { MEDHAVA: 'manuals/U2_ERP_MANUAL.md', VASTRANGAM: 'manuals/U2_VAS_MANUAL.md' },
    pdf: { MEDHAVA: 'out/Medhava_M02_App4_U2_ERP.pdf', VASTRANGAM: 'out/Medhava_M02_App4_U2_VAS.pdf' },
