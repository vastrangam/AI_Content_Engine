'use strict';
/* Module 05 · Sales — the single description of the module. The packager builds the ZIPs
...
module.exports = {
  num: '05', slug: 'Sales', title: 'Sales',
  overviewPdf: 'out/Medhava_Module_05_Sales.pdf',
