'use strict';
/* Module 21 — the single description of the module. The packager builds the ZIPs from it AND
...
module.exports = {
  num: '21', slug: 'Dashboard_BI', title: 'Dashboard & BI',
  overviewPdf: 'out/Medhava_Module_21_Dashboard_BI.pdf',
  ...
  apps: [
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M21_App1_DASH_ERP.pdf', VASTRANGAM: 'out/Medhava_M21_App1_DASH_VAS.pdf' },
    ...
    },
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M21_App2_REP_ERP.pdf', VASTRANGAM: 'out/Medhava_M21_App2_REP_VAS.pdf' },
    ...
    },
    {
      ...
      pdf: { MEDHAVA: 'out/Medhava_M21_App3_GRP_ERP.pdf', VASTRANGAM: 'out/Medhava_M21_App3_GRP_VAS.pdf' },
  ...
  unified: {
    n: '04', slug: 'All_Three_In_One', name: 'Module 21 · All three apps in one', screens: 17, tests: 37,
    html: { MEDHAVA: 'out/m21_ERP.html', VASTRANGAM: 'out/m21_Vastrangam.html' },
    manual: { MEDHAVA: 'manuals/UNI_ERP_MANUAL.md', VASTRANGAM: 'manuals/UNI_VAS_MANUAL.md' },
    pdf: { MEDHAVA: 'out/Medhava_M21_App4_UNI_ERP.pdf', VASTRANGAM: 'out/Medhava_M21_App4_UNI_VAS.pdf' },
