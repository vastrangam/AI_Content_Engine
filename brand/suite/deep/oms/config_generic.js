...
var CONFIG={
  ...
  orders:[
    ...
    {id:'MP-4108',cust:'Vishitasompura Sethi',market:'MPA',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:16,status:'delivered'},
    ...
    {id:'MP-4113',cust:'yashjadeja Menon',market:'MPG',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:26,status:'packed'},
  ...
  wiring:[
    ...
    {f:'Settlement',s:'Settlement module',h:'This app says what the payout should be; Settlement checks what actually arrived'},
