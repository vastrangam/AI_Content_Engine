...
var CONFIG={
  ...
  orders:[
    {id:'MP-4101',cust:'Ananya Rao',market:'MPB',sku:'FG-102',name:'Premium product',qty:1,rate:4999,age:22,size:'Free size',addr:'H.No. 42, Zoo Road, Guwahati, Assam 781005',status:'new'},
    {id:'MP-4102',cust:'Rohit Verma',market:'MPA',sku:'FG-101',name:'Standard product',qty:2,rate:1799,age:18,size:'L',addr:'B-7 Anna Nagar West, Chennai, Tamil Nadu 600040',status:'accepted'},
    {id:'MP-4103',cust:'Sneha Iyer',market:'MPC',sku:'FG-103',name:'Accessory',qty:1,rate:899,age:20,size:'Free size',addr:'3rd Cross, Jayanagar 4th Block, Bengaluru 560011',status:'packed'},
    {id:'MP-4104',cust:'Karan Mehta',market:'MPD',sku:'FG-104',name:'Top-of-range product',qty:1,rate:12999,age:30,size:'M',addr:'Plot 18, Vijayanagar, Mysuru, Karnataka 570017',status:'new'},
    {id:'MP-4105',cust:'Divya Nair',market:'MPE',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:40,size:'S',addr:'204 Gomti Nagar, Lucknow, Uttar Pradesh 226010',status:'accepted'},
    {id:'MP-4106',cust:'Meera Joshi',market:'MPF',sku:'FG-101',name:'Standard product',qty:3,rate:1799,age:30,size:'XL',addr:'Flat 9B, Kothrud, Pune, Maharashtra 411038',status:'dispatched'},
    {id:'MP-4107',cust:'Tanvi Shah',market:'MPB',sku:'FG-102',name:'Premium product',qty:1,rate:4999,age:20,size:'Free size',addr:'12 Adajan Road, Surat, Gujarat 395009',status:'delivered'},
    {id:'MP-4108',cust:'Vishitasompura Sethi',market:'MPA',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:16,size:'M',addr:'C-56 Sector 62, Noida, Uttar Pradesh 201309',status:'delivered'},
    {id:'MP-4109',cust:'Neha Bhatt',market:'MPB',sku:'FG-102',name:'Premium product',qty:1,rate:4999,age:26,size:'Free size',addr:'7 Panampilly Nagar, Kochi, Kerala 682036',status:'returned'},
    {id:'MP-4110',cust:'Arjun Pillai',market:'MPD',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:30,size:'L',addr:'221 Race Course Road, Coimbatore 641018',status:'returned'},
    {id:'MP-4111',cust:'Ritu Saxena',market:'MPB',sku:'FG-103',name:'Accessory',qty:2,rate:899,age:18,size:'Free size',addr:'A-3 Mansarovar, Jaipur, Rajasthan 302020',status:'delivered'},
    {id:'MP-4112',cust:'Sameer Khan',market:'MPG',sku:'FG-102',name:'Premium product',qty:1,rate:4999,age:10,size:'Free size',addr:'19 Boring Road, Patna, Bihar 800001',status:'cancelled'},
    {id:'MP-4113',cust:'YashJadeja Menon',market:'MPG',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:26,size:'S',addr:'44 Salt Lake Sector 2, Kolkata 700091',status:'packed'},
    {id:'MP-4114',cust:'Harsh Agarwal',market:'MPC',sku:'FG-104',name:'Top-of-range product',qty:1,rate:12999,age:22,size:'M',addr:'8 Sector 15, Chandigarh 160015',status:'delivered'},
    {id:'MP-4115',cust:'Lata Kulkarni',market:'MPB',sku:'FG-101',name:'Standard product',qty:2,rate:1799,age:20,size:'L',addr:'66 Gangapur Road, Nashik, Maharashtra 422013',status:'delivered'},
    {id:'MP-4116',cust:'Faiz Ahmed',market:'MPD',sku:'FG-101',name:'Standard product',qty:1,rate:1799,age:44,size:'XL',addr:'31 Alkapuri, Vadodara, Gujarat 390007',status:'delivered'}],
  ...
  slipNote:'A packing slip is a picking and shipping document, not a tax invoice. It carries the design code, the size, the quantity and where the parcel is going — everything the person at the packing table needs and nothing else. Prices are deliberately left off: the marketplace prints its own invoice for the customer, and a second price on a second piece of paper is how disputes start. The design code is set in a size you can read across a rack, because the whole cost of a wrong dispatch is one person reading the wrong line at speed.',
  wiring:[
