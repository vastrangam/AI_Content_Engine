...
var CONFIG={
  ...
  orders:[
    {id:'VS-M-4101',cust:'Ananya Rao',market:'MYN',sku:'VS-SAR-02',name:'Banarasi saree',qty:1,rate:4999,age:22,size:'Free size',addr:'H.No. 42, Zoo Road, Guwahati, Assam 781005',status:'new'},
    {id:'VS-M-4102',cust:'Rohit Verma',market:'AMZ',sku:'VS-KUR-01',name:'Cotton kurta set',qty:2,rate:1799,age:18,size:'L',addr:'B-7 Anna Nagar West, Chennai, Tamil Nadu 600040',status:'accepted'},
    {id:'VS-M-4103',cust:'Sneha Iyer',market:'FKT',sku:'VS-DUP-03',name:'Zari dupatta',qty:1,rate:899,age:20,size:'Free size',addr:'3rd Cross, Jayanagar 4th Block, Bengaluru 560011',status:'packed'},
    {id:'VS-M-4104',cust:'Karan Mehta',market:'AJIO',sku:'VS-LEH-04',name:'Bridal lehenga',qty:1,rate:12999,age:30,size:'M',addr:'Plot 18, Vijayanagar, Mysuru, Karnataka 570017',status:'new'},
    {id:'VS-M-4105',cust:'Divya Nair',market:'NYK',sku:'VS-KUR-01',name:'Cotton kurta set',qty:1,rate:1799,age:40,size:'S',addr:'204 Gomti Nagar, Lucknow, Uttar Pradesh 226010',status:'accepted'},
    {id:'VS-M-4106',cust:'Meera Joshi',market:'MEE',sku:'VS-KUR-01',name:'Cotton kurta set',qty:3,rate:1799,age:30,size:'XL',addr:'Flat 9B, Kothrud, Pune, Maharashtra 411038',status:'dispatched'},
    {id:'VS-M-4107',cust:'Tanvi Shah',market:'MYN',sku:'VS-SAR-02',name:'Banarasi saree',qty:1,rate:4999,age:20,size:'Free size',addr:'12 Adajan Road, Surat, Gujarat 395009',status:'delivered'},
    {id:'VS-M-4108',cust:'Vikram Sethi',market:'AMZ',sku:'VS-KUR-01',name:'Cotton kurta set',qty:1,rate:1799,age:16,size:'M',addr:'C-56 Sector 62, Noida, Uttar Pradesh 201309',status:'delivered'},
    {id:'VS-M-4109',cust:'Neha Bhatt',market:'MYN',sku:'VS-SAR-02',name:'Banarasi saree',qty:1,rate:4999,age:26,size:'Free size',addr:'7 Panampilly Nagar, Kochi, Kerala 682036',status:'returned'},
    ...
    {id:'VS-M-4113',cust:'Pooja Menon',market:'TCL',sku:'VS-KUR-01',name:'Cotton kurta set',qty:1,rate:1799,age:26,size:'S',addr:'44 Salt Lake Sector 2, Kolkata 700091',status:'packed'},
  ...
  slipNote:'A packing slip is a picking and shipping document, not a tax invoice. It carries the design code, the size, the quantity and the delivery address — what the person at the packing table needs, and nothing else. Rates are deliberately left off: Myntra and Amazon print their own invoice for the customer, and a second price on a second piece of paper is how a dispute starts. The design code is set large enough to read across a rack, because a Banarasi saree and a Kanjivaram look identical from four feet away and the whole cost of that mistake is a return at your expense.',
  wiring:[
    ...
    {f:'Settlement',s:'Settlement',h:'This app says what the payout should be; Settlement checks what Myntra actually paid'},
