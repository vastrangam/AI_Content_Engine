...
var CONFIG={
  ...
  orders:[
    ...
    {id:'OM-7110',cust:'Vishitasompura Sethi',channel:'CH-WEB',sku:'FG-102',name:'Premium product',qty:1,rate:4999,city:'Kochi',zone:'Z-S',date:'2026-07-28',hr:10,status:'shipped',loc:'W3',doneOn:'',recv:false,insp:'',refund:0},
    ...
    {id:'OM-7116',cust:'yashjadeja Menon',channel:'CH-MKT',sku:'FG-102',name:'Premium product',qty:1,rate:4999,city:'Faridabad',zone:'Z-N',date:'2026-07-12',hr:10,status:'returned',loc:'W1',doneOn:'2026-07-13',recv:true,insp:'',refund:0},
  ...
  wiringIn:[
    ...
    {from:'Inventory / Warehouse',what:'How many pieces each warehouse actually holds'},
