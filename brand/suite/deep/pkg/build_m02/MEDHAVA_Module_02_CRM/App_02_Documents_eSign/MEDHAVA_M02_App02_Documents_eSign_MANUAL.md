...
WHAT YOU NEED
  ...
  The whole app is ONE file: MEDHAVA_M02_App02_Documents_eSign.html
  About 136 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file MEDHAVA_M02_App02_Documents_eSign.html — usually in your Downloads folder.
  ...
  2. Double-click MEDHAVA_M02_App02_Documents_eSign.html.
...
ON A MAC
  1. Find MEDHAVA_M02_App02_Documents_eSign.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click MEDHAVA_M02_App02_Documents_eSign.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save MEDHAVA_M02_App02_Documents_eSign.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap MEDHAVA_M02_App02_Documents_eSign.html.
...
ON AN IPHONE OR IPAD
  1. Save MEDHAVA_M02_App02_Documents_eSign.html to the "Files" app (Save to Files from WhatsApp, Mail
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — MEDHAVA_M02_App02_Documents_eSign.html AND the backup.
  3. On the new device: open MEDHAVA_M02_App02_Documents_eSign.html, then "Backup & Health" →
...
**File you need:** `MEDHAVA_M02_App02_Documents_eSign.html` · opens by double-click · works offline · 41 self-tests
