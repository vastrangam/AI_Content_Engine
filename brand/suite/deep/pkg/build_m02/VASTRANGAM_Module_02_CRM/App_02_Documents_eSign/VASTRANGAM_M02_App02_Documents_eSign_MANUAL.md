...
arithmetic 41 different ways every time it starts.
...
WHAT YOU NEED
  ...
  The whole app is ONE file: VASTRANGAM_M02_App02_Documents_eSign.html
  About 136 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file VASTRANGAM_M02_App02_Documents_eSign.html — usually in your Downloads folder.
  ...
  2. Double-click VASTRANGAM_M02_App02_Documents_eSign.html.
...
ON A MAC
  1. Find VASTRANGAM_M02_App02_Documents_eSign.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click VASTRANGAM_M02_App02_Documents_eSign.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save VASTRANGAM_M02_App02_Documents_eSign.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap VASTRANGAM_M02_App02_Documents_eSign.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Documents & eSign directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save VASTRANGAM_M02_App02_Documents_eSign.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Documents & eSign has its own icon on your home screen.
...
Every document here is filed against something that exists:
     ...
     Party · Order · Style or job · Person

Not a folder. Not a date. The record it actually belongs to.

  A clothing house files against a STYLE or a JOB. A mill agreement
  ...
  TRY IT:
     ...
     5. Now put P1 in "Which record" and press "File it" again.
        It goes on file — and it appears on that buyer's record.
...
──────────────────────────────────────────────
  ✗ It cannot create a buyer, an order or a ticket. It files
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_docs_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — VASTRANGAM_M02_App02_Documents_eSign.html AND the backup.
  3. On the new device: open VASTRANGAM_M02_App02_Documents_eSign.html, then "Backup & Health" →
...
**File you need:** `VASTRANGAM_M02_App02_Documents_eSign.html` · opens by double-click · works offline · 41 self-tests
**Companion app in this module:** CRM & Customer 360 · Helpdesk & Live Chat · and all three in one
