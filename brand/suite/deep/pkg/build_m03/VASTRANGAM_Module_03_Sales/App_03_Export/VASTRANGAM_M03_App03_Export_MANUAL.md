# Export — Complete Manual
### Medhava · Vastrangam — ethnic-wear D2C + marketplace
**Module 03 · Sales — App 3 of 5**
...
WHAT YOU NEED
  ...
  The whole app is ONE file: Export.html
  About 73 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file Export.html — usually in your Downloads folder.
...
ON A MAC
  1. Find Export.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click Export.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save Export.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap Export.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Export directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save Export.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Export has its own icon on your home screen.
...
THE TWO LAWFUL ROUTES  (bottom panel)
  ...
  If you export more than a few times a year the LUT bond is almost always right: one filing, and the tax money stays in your account.
...
BOOK A SHIPMENT
  Overseas buyer · Country · Item · Quantity · Rate per unit (in USD) ·
  Tax route.

THE TABLE
  FOB in USD and FOB in ₹ side by side, the route, the IGST if any, and
...
WHAT THE SCREEN SHOWS
  ...
  Alternatives available       How many different options you can pick from
                               across those capabilities — 76 in this app.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_exp_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — Export.html AND the backup.
  3. On the new device: open Export.html, then "Backup & Health" →
...
Every time Export opens, it quietly checks its own arithmetic — 34
...
language, so you can read what was actually checked. For example:
  ...
  · "no shipment sailed with an incomplete set of papers"
...
**File you need:** `Export.html` · opens by double-click · works offline · 34 self-tests
**Companion app in this module:** D2C Sales · B2B & Credit · POS · Quotes & Proforma
