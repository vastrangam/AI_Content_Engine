...
WHAT YOU NEED
  ...
  The whole app is ONE file: MEDHAVA_M04_App01_CRM_Customer_360.html
  About 138 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file MEDHAVA_M04_App01_CRM_Customer_360.html — usually in your Downloads folder.
  ...
  2. Double-click MEDHAVA_M04_App01_CRM_Customer_360.html.
...
ON A MAC
  1. Find MEDHAVA_M04_App01_CRM_Customer_360.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click MEDHAVA_M04_App01_CRM_Customer_360.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save MEDHAVA_M04_App01_CRM_Customer_360.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap MEDHAVA_M04_App01_CRM_Customer_360.html.
...
ON AN IPHONE OR IPAD
  1. Save MEDHAVA_M04_App01_CRM_Customer_360.html to the "Files" app (Save to Files from WhatsApp, Mail
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_crm_erp_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — MEDHAVA_M04_App01_CRM_Customer_360.html AND the backup.
  3. On the new device: open MEDHAVA_M04_App01_CRM_Customer_360.html, then "Backup & Health" →
...
**File you need:** `MEDHAVA_M04_App01_CRM_Customer_360.html` · opens by double-click · works offline · 42 self-tests
