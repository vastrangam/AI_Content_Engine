...
WHAT YOU NEED
  ...
  The whole app is ONE file: MEDHAVA_M04_App02_Documents_eSign.html
  About 136 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file MEDHAVA_M04_App02_Documents_eSign.html — usually in your Downloads folder.
  ...
  2. Double-click MEDHAVA_M04_App02_Documents_eSign.html.
...
ON A MAC
  1. Find MEDHAVA_M04_App02_Documents_eSign.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click MEDHAVA_M04_App02_Documents_eSign.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save MEDHAVA_M04_App02_Documents_eSign.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap MEDHAVA_M04_App02_Documents_eSign.html.
...
ON AN IPHONE OR IPAD
  1. Save MEDHAVA_M04_App02_Documents_eSign.html to the "Files" app (Save to Files from WhatsApp, Mail
...
Every document here is filed against something that exists:
     ...
     Party · Order · Project or case · Person

Not a folder. Not a date. The record it actually belongs to.

  A law practice files against a CASE. A workshop files against a JOB.
  ...
  TRY IT:
     ...
     5. Now put P1 in "Which record" and press "File it" again.
        It goes on file — and it appears on that customer's record.
...
──────────────────────────────────────────────
  ✗ It cannot create a customer, an order or a ticket. It files
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_docs_erp_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — MEDHAVA_M04_App02_Documents_eSign.html AND the backup.
  3. On the new device: open MEDHAVA_M04_App02_Documents_eSign.html, then "Backup & Health" →
...
**File you need:** `MEDHAVA_M04_App02_Documents_eSign.html` · opens by double-click · works offline · 41 self-tests
