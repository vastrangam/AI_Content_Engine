...
WHAT YOU NEED
  ...
  The whole app is ONE file: MEDHAVA_M04_App03_Helpdesk_Live_Chat.html
  About 137 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file MEDHAVA_M04_App03_Helpdesk_Live_Chat.html — usually in your Downloads folder.
  ...
  2. Double-click MEDHAVA_M04_App03_Helpdesk_Live_Chat.html.
...
ON A MAC
  1. Find MEDHAVA_M04_App03_Helpdesk_Live_Chat.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click MEDHAVA_M04_App03_Helpdesk_Live_Chat.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save MEDHAVA_M04_App03_Helpdesk_Live_Chat.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap MEDHAVA_M04_App03_Helpdesk_Live_Chat.html.
...
ON AN IPHONE OR IPAD
  1. Save MEDHAVA_M04_App03_Helpdesk_Live_Chat.html to the "Files" app (Save to Files from WhatsApp, Mail
...
════════════════════════════════════════════════════════════════════════
  ...
  THE ONE RECORD  This is the idea the whole module is built on, and once it
                  ...
                  customer, one record, whatever you file or ask against it.
...
Here there is NO SUCH FIELD. There is nowhere to put one.
  ...
  Every message on it has a time and a side: the customer, or us.
  ...
  SEE IT HAPPEN:
     ...
     2. Open T-503 — "Disputing the return credit".
...
numbers look BEST exactly when the service was worst.
  ...
  TRY IT:
     ...
     3. REFUSED — and the reason says nobody has answered this customer.
...
──────────────────────────────────────────────────────────────
This is how one customer gets told about another customer's
delivery, and it is always a typo, never malice.

  TRY IT:
     1. Open a ticket. Find "Which order is this about?".
     2. Type an order number belonging to a different customer.
     3. Press "Attach the order".
     4. REFUSED — and the refusal NAMES BOTH CUSTOMERS,
...
RIGHT PANEL — ALREADY KNOWN ABOUT THEM
  ...
  customer record are the same records.
...
──────────────────────────────────────────────
  ✗ It cannot edit an order or a customer. It reads them.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_helpdesk_erp_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — MEDHAVA_M04_App03_Helpdesk_Live_Chat.html AND the backup.
  3. On the new device: open MEDHAVA_M04_App03_Helpdesk_Live_Chat.html, then "Backup & Health" →
...
**File you need:** `MEDHAVA_M04_App03_Helpdesk_Live_Chat.html` · opens by double-click · works offline · 38 self-tests
