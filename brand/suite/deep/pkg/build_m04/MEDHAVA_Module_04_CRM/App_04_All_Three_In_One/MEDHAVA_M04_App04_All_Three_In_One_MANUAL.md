...
WHAT YOU NEED
  ...
  The whole app is ONE file: MEDHAVA_M04_App04_All_Three_In_One.html
  About 177 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file MEDHAVA_M04_App04_All_Three_In_One.html — usually in your Downloads folder.
  ...
  2. Double-click MEDHAVA_M04_App04_All_Three_In_One.html.
...
ON A MAC
  1. Find MEDHAVA_M04_App04_All_Three_In_One.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click MEDHAVA_M04_App04_All_Three_In_One.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save MEDHAVA_M04_App04_All_Three_In_One.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap MEDHAVA_M04_App04_All_Three_In_One.html.
...
ON AN IPHONE OR IPAD
  1. Save MEDHAVA_M04_App04_All_Three_In_One.html to the "Files" app (Save to Files from WhatsApp, Mail
...
list, that customer's documents and their tickets are all ready in
...
PART A · ONE DEAL, THREE APPS   (three minutes)
  ...
  5. Now win Deepak Iyer's deal at Coastal Wholesale.
     You have never sold to them.
     "Customers" now says 9. Exactly one appeared.

  6. Open "Customer 360" and pick that new customer.
...
PART B · A DOCUMENT, AND THE SIGNATURE GATE   (three minutes)
  ...
  9. Open "Customer 360" → pick Northline Retail Pvt Ltd.
...
PART C · A TICKET, AND THE CLOCK   (two minutes)
 ...
 14. Press "Close this ticket".
     → REFUSED. Nobody has answered this customer yet.

 15. In "Which order is this about?", type an order number belonging to a
     DIFFERENT customer. Press "Attach the order".
 ...
 18. Open "Customer 360" for that customer. The ticket is on their
...
PART D · YOUR OWN RECORDS   (two minutes)
 ...
 20. Add one:
        ...
        Party     — pick Northline Retail Pvt Ltd
        Date      — 2026-07-15
        Amount    — 50000
        Returned  — 5000
        Channel   — pick any
 ...
 21. Open "Customer 360" for Northline Retail Pvt Ltd. Their WORTH has gone up by
...
WHAT IT WILL NOT ACCEPT
  ...
  same engine, with the same sentences:
     · a row naming a customer that does not exist
       ("add the party first")
...
A KINDNESS WORTH KNOWING
  Anywhere a customer is asked for, you may give either the code
  (P1) or the full name (Northline Retail Pvt Ltd). Both work. A typo in
  the name is refused rather than quietly creating a second customer,
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_m02_erp_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — MEDHAVA_M04_App04_All_Three_In_One.html AND the backup.
  3. On the new device: open MEDHAVA_M04_App04_All_Three_In_One.html, then "Backup & Health" →
...
**File you need:** `MEDHAVA_M04_App04_All_Three_In_One.html` · opens by double-click · works offline · 49 self-tests
