...
WHAT YOU NEED
  ...
  The whole app is ONE file: VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html
  About 137 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html — usually in your Downloads folder.
  ...
  2. Double-click VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html.
...
ON A MAC
  1. Find VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html.
...
ON AN IPHONE OR IPAD
  1. Save VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html to the "Files" app (Save to Files from WhatsApp, Mail
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html AND the backup.
  3. On the new device: open VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html, then "Backup & Health" →
...
**File you need:** `VASTRANGAM_M04_App03_Helpdesk_Live_Chat.html` · opens by double-click · works offline · 38 self-tests
