# Module 04 · All three apps in one — Complete Manual
### Medhava · Vastrangam — its own buyers, mills and marketplaces
**Module 04 · CRM — App 4 of 4**
...
════════════════════════════════════════════════════════════════════════
   ...
   M E D H A V A  ·  MODULE 04 · ALL THREE APPS IN ONE
   Vastrangam — its own buyers, mills and marketplaces
   Module 04 · CRM — App 4 of 4
...
arithmetic 49 different ways every time it starts.
...
WHAT YOU NEED
  ...
  The whole app is ONE file: VASTRANGAM_M04_App04_All_Three_In_One.html
  About 177 KB — smaller than a photo from your phone.


ON A WINDOWS COMPUTER
  1. Find the file VASTRANGAM_M04_App04_All_Three_In_One.html — usually in your Downloads folder.
  ...
  2. Double-click VASTRANGAM_M04_App04_All_Three_In_One.html.
...
ON A MAC
  1. Find VASTRANGAM_M04_App04_All_Three_In_One.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click VASTRANGAM_M04_App04_All_Three_In_One.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save VASTRANGAM_M04_App04_All_Three_In_One.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap VASTRANGAM_M04_App04_All_Three_In_One.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Module 04 · All three apps in one directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save VASTRANGAM_M04_App04_All_Three_In_One.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Module 04 · All three apps in one has its own icon on your home screen.
...
list, that buyer's documents and their tickets are all ready in
...
only ever one set of records underneath all three.
  ...
  THE ONE RECORD  This is the idea the whole module is built on, and once it
                  ...
                  A buyer you have never sold to yet is a LEAD.
                  It has a stage, and every stage carries a real probability.

                  You win it. The SAME record becomes the buyer.
                  ...
                  their head while a buyer waits.

                  Worse, the CRM usually ends up with the same buyer
  ...
  WHAT IS NEVER TYPED
                  ...
                  there is no field to put them in:
                    ...
                    · what a buyer is worth      (orders minus returns)
...
PART A · ONE DEAL, THREE APPS   (three minutes)
  ...
  2. Open "Pipeline". Find the deal for Priya Menon at
     Rajmandir Wholesale (Surat).
  ...
  5. Now win Deepak Iyer's deal at Coastal Ethnic Wholesale.
     You have never sold to them.
     "Customers" now says 9. Exactly one appeared.

  6. Open "Customer 360" and pick that new buyer.
...
PART B · A DOCUMENT, AND THE SIGNATURE GATE   (three minutes)
  ...
  8. Change "Which record" to P1 and press "File it".
     → On file, as a draft.

  9. Open "Customer 360" → pick Rajmandir Wholesale (Surat).
...
PART C · A TICKET, AND THE CLOCK   (two minutes)
 ...
 13. Open "Tickets" → "Not answered yet". Open T-503.
     First reply says "—".

 14. Press "Close this ticket".
     → REFUSED. Nobody has answered this buyer yet.

 15. In "Which order is this about?", type an order number belonging to a
     DIFFERENT buyer. Press "Attach the order".
 ...
 18. Open "Customer 360" for that buyer. The ticket is on their
...
PART D · YOUR OWN RECORDS   (two minutes)
 ...
 20. Add one:
        ...
        Party     — pick Rajmandir Wholesale (Surat)
        Date      — 2026-07-15
        Amount    — 50000
        Returned  — 5000
        Channel   — pick any
 ...
 21. Open "Customer 360" for Rajmandir Wholesale (Surat). Their WORTH has gone up by
...
WHAT IT WILL NOT ACCEPT
  ...
  same engine, with the same sentences:
     · a row naming a buyer that does not exist
       ("add the party first")
...
A KINDNESS WORTH KNOWING
  Anywhere a buyer is asked for, you may give either the code
  (P1) or the full name (Rajmandir Wholesale (Surat)). Both work. A typo in
  the name is refused rather than quietly creating a second buyer,
...
WHAT THE SCREEN SHOWS
  ...
  Capabilities used            The outside things this app can talk to.
                               Module 04 · All three apps in one uses 7.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_m02_vastrangam_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — VASTRANGAM_M04_App04_All_Three_In_One.html AND the backup.
  3. On the new device: open VASTRANGAM_M04_App04_All_Three_In_One.html, then "Backup & Health" →
...
Every time Module 04 · All three apps in one opens, it quietly checks its own arithmetic — 49
separate checks — before showing you anything. You can see the result:

  Click "Backup & Health" → look at the "Self-tests" panel.

You should see 49/49 pass. Each line is written in plain
language, so you can read what was actually checked. For example:

  · "one party’s timeline carries all three apps at once"
...
**File you need:** `VASTRANGAM_M04_App04_All_Three_In_One.html` · opens by double-click · works offline · 49 self-tests
**Companion app in this module:** CRM & Customer 360 · Documents & eSign · Helpdesk & Live Chat (the same three, separately)
