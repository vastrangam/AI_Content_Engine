...
WHERE THE ORDERS ARE
  ...
  Every COD parcel can be refused at the door, and you pay the courier both ways.
...
to win back, and almost nobody chases it.
  ...
  A cart abandoned in the last week is still warm — the person remembers what they wanted and why. After a week the reason has usually gone.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_d2c_erp_v1".
