# Marketplace OMS — Complete Manual
### Medhava · Unified ERP — any industry
**Module 04 · E-commerce / OMS — App 1 of 2**
...
ON A WINDOWS COMPUTER
  1. Find the file Marketplace_OMS.html — usually in your Downloads folder.
  ...
  2. Double-click Marketplace_OMS.html.
...
ON A MAC
  1. Find Marketplace_OMS.html in Downloads. If it came in a ZIP, double-click the ZIP
     to unpack it first.
  2. Double-click Marketplace_OMS.html. Safari opens it.
  3. Done.
...
ON AN ANDROID PHONE OR TABLET
  1. Save Marketplace_OMS.html to your phone. Any route works — WhatsApp, email,
     Google Drive, or a USB cable from your computer.
  2. Open the "Files" app (some phones call it "My Files").
  3. Go to Downloads and tap Marketplace_OMS.html.
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Marketplace OMS directly, with no browser bar. Exactly like any other app,
     and it still works with the phone in flight mode.


ON AN IPHONE OR IPAD
  1. Save Marketplace_OMS.html to the "Files" app (Save to Files from WhatsApp, Mail
  ...
  MAKE IT LOOK AND FEEL LIKE A REAL APP:
     ...
     Now Marketplace OMS has its own icon on your home screen.
...
WHAT EACH MARKETPLACE ACTUALLY PAYS YOU
  ...
  A panel that sells the most is frequently not the panel that pays the most. This is the only screen in most businesses where those two are shown together.
...
Everything still to go out, from every panel, in ONE list.
  ...
  That is the whole point. One panel gives you 12 hours; another gives you 48.
...
WHAT IS ON ONE SLIP
  ...
  ┌───────────────────────────────────┐
  │ PICK THIS DESIGN                  │
  │ FG-101                     │   ← large enough to read across a rack
  │ Size L · 2 pieces                 │
  └───────────────────────────────────┘
...
WHAT IS DELIBERATELY *NOT* ON IT
  NO PRICES. The marketplace prints its own invoice for the customer. A second price on a second piece of paper is how a dispute starts.
...
late right now.
  ...
  The ranking here is almost never the ranking by gross, which is exactly why it is worth having.
...
"LEVEL THE PRICE"
  ...
  Marketplaces read each other's prices. The same item listed materially cheaper on one panel gets the dearer listings suppressed — on a channel you are paying a high commission to be visible on.
...
WHERE IS MY DATA KEPT?
  ...
  file, labelled "medhava_oms_erp_v1".
...
MOVING FROM YOUR COMPUTER TO YOUR PHONE (or to a new machine)
  ...
  2. Send yourself both files — Marketplace_OMS.html AND the backup.
  3. On the new device: open Marketplace_OMS.html, then "Backup & Health" →
