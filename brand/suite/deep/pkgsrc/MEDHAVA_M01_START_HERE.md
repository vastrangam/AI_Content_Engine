...
├── MEDHAVA_M01_Module_Overview.pdf        ← 10 pages: the whole module, how it wires together
│
...
The Vastrangam edition ships in its own ZIP alongside this one, with **VASTRANGAM_** on
every file.
