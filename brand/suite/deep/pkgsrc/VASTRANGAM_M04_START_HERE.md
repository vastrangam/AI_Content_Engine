...
│
├── VASTRANGAM_M04_START_HERE.md              ← you are reading this
├── VASTRANGAM_M04_Module_Overview.pdf        ← the whole module, how it wires together
│
├── App_01_Marketplace_OMS/
│    ├── VASTRANGAM_M04_App01_Marketplace_OMS.html          ← DOUBLE-CLICK THIS
│    ├── VASTRANGAM_M04_App01_Marketplace_OMS_MANUAL.md
│    └── VASTRANGAM_M04_App01_Marketplace_OMS_WIRING.pdf
│
└── App_02_Order_Management/
     ├── VASTRANGAM_M04_App02_Order_Management.html          ← DOUBLE-CLICK THIS
...
| 03 | Sales — D2C Sales · B2B & Credit · Export · POS · Quotes & Proforma · Couriers & AWB | Delivered |
| **04** | **E-commerce / OMS — Marketplace OMS · Order Management · Manual Data Check · Reconciliation · Claims & Disputes · Returns / RMA · Channels & Storefronts · Labels & Documents** | **Delivered — this ZIP** |
| 05 | Warehouse — Picking & Bins · Barcode Operations · Packing Video | Next |
...
Module 04 · E-commerce / OMS · Vastrangam · FY 2026-27
