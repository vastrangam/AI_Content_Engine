...
var CONFIG={
  ...
  wiring:[
    {from:'GRN accepted qty',to:'Inventory / Stock',what:'Stock IN at receiving location (single source of truth)'},
    {from:'Supplier invoice (matched)',to:'Finance / Ledger',what:'Vendor payable + Input Tax Credit on accepted value'},
    {from:'GRN rejected qty',to:'Quality + Finance',what:'Debit note to vendor + quality flag on scorecard'},
    {from:'PO approved',to:'Budget / Commitments',what:'Committed spend against cost centre / budget'},
    {from:'RFQ awarded',to:'Master Data (Party)',what:'Preferred-vendor + agreed price for the item'},
    {from:'Vendor scorecard',to:'Master Data',what:'On-time / quality rating drives future sourcing'}],
  wiringIn:[
    ...
    {from:'Master Data',what:'Item master, vendor master, tax/HSN rates'},
    {from:'Automation',what:'“If stock < reorder then draft PO to preferred vendor”'}]
};
