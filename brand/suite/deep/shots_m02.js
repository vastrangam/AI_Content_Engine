...
const BUILDS = [
  { file: 'crm_ERP.html', tag: 'CRM_ERP', lead: { name: 'bhavinraval Rao', co: 'Westport Retail Pvt Ltd', val: '365000' } },
  { file: 'crm_Vastrangam.html', tag: 'CRM_VAS', lead: { name: 'bhavinraval Rao', co: 'Bandhej House (Jodhpur)', val: '365000' } },
];
