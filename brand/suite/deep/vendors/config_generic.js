...
var CONFIG={
  ...
  wiring:[
    {from:'Vendor created / updated',to:'Master Data (Party)',what:'One supplier identity every module reads — Procurement, Finance, Quality'},
    {from:'Performance score',to:'Procurement',what:'RFQs and POs route to the best-performing supplier in that category'},
    {from:'Payable balance',to:'Finance / Ledger',what:'Accounts-payable position and the payment run'},
    {from:'Aging buckets',to:'Treasury / Cash-flow',what:'What must be paid this week vs this month'},
    {from:'Risk band',to:'Sourcing & Management',what:'High-risk suppliers trigger dual-sourcing and a review'},
    {from:'Spend concentration',to:'Board / BI',what:'Single-supplier dependency flagged before it becomes a failure'}],
  wiringIn:[
    {from:'Procurement',what:'GRN results (received / accepted / rejected, on-time) build the performance history'},
    {from:'Finance',what:'Payments post against bills and clear the outstanding balance'},
    {from:'Quality',what:'Rejections and debit notes lower the accept rate'},
    {from:'Master Data',what:'GSTIN, payment terms, tax and category definitions'}]
};
