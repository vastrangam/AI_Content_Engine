'use strict';
/* Every concrete claim the Module 02 manuals make, checked against the shipped HTML.
...
const BUILDS = [
  ...
  { file: 'm02_ERP.html', tag: 'U2_ERP', kind: 'uni', ed: 'ERP' },
  { file: 'm02_Vastrangam.html', tag: 'U2_VAS', kind: 'uni', ed: 'VAS' },
];
