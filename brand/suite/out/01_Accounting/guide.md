...
> Double-entry books, GST & P&L — every voucher balances.
...
## What works
A real double-entry ledger. Post a voucher and the Trial Balance always balances; the P&L and GST are computed from the postings, not typed in.
