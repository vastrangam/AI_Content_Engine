...
## What works
A real stock ledger across three locations. On-hand, valuation (at cost) and retail value are computed from item balances; every adjustment writes a move, and transfers conserve total quantity.
