...
> Leads, pipeline & stages — see weighted value move from New to Won.
...
## What works
A sales pipeline. Leads carry a value and a stage; advancing a lead moves it toward Won. Pipeline value, won value and win-rate are all computed from the lead set.
