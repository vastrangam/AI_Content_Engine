...
> One product record, every channel — completeness scored before you list.
...
## What works
A product information hub. Each product is scored on the nine attributes a marketplace needs; only 100%-complete products are channel-ready. Add a product and watch its score compute from what you fill.
