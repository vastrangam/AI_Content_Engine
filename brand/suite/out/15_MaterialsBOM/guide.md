# Medhava · Materials / BOM

> Raw materials & bills of materials — costed product recipes from live rates.
...
## What works
A materials store plus product recipes. Material value is stock × cost; each BOM rolls up to a product cost from current material rates, so a rate change reprices every product that uses it.
